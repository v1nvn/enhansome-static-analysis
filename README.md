...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,377 | 🐛 2 | 🌐 Rust | 📅 2026-02-11
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,068 | 🐛 0 | 🌐 Markdown | 📅 2026-02-06.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,112 | 🐛 44 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,792 | 🐛 73 | 🌐 Python | 📅 2026-02-02 — Automated C++ checker that follows Google's style guide.

* [clazy](https://github.com/KDE/clazy) ⭐ 728 | 🐛 0 | 🌐 C++ | 📅 2026-02-08 — Qt-oriented static code analyzer based on the Clang framework. clazy is a compiler plugin which allows clang to understand Qt semantics. You get more than 50 Qt related compiler warnings, ranging from unneeded memory allocations to misusage of API, including fix-its for automatic refactoring.

* [CMetrics](https://github.com/MetricsGrimoire/CMetrics) ⭐ 79 | 🐛 1 | 🌐 Shell | 📅 2015-03-24 — Measures size and complexity for C files.

* [cqmetrics](https://github.com/dspinellis/cqmetrics) ⭐ 68 | 🐛 4 | 🌐 C++ | 📅 2022-06-14 — Quality metrics for C code.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,378 | 🐛 214 | 🌐 C# | 📅 2026-02-07 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,182 | 🐛 34 | 🌐 C# | 📅 2026-02-13 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,090 | 🐛 2 | 🌐 C# | 📅 2026-02-10 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 892 | 🐛 238 | 🌐 C# | 📅 2026-02-13 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,820 | 🐛 99 | 🌐 Clojure | 📅 2026-02-09 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [lint](https://github.com/passsy/dart-lint) ⭐ 279 | 🐛 15 | 📅 2025-02-24 — An opinionated, community-driven set of lint rules for Dart and Flutter projects. Like pedantic but stricter
...
* [DelphiLint](https://github.com/integrated-application-development/delphilint) ⭐ 127 | 🐛 11 | 🌐 Pascal | 📅 2026-01-27 — A Delphi IDE package providing on-the-fly code analysis and linting, powered by SonarDelphi.
...
* [D-scanner](https://github.com/dlang-community/D-Scanner) ⭐ 251 | 🐛 128 | 🌐 D | 📅 2025-12-27 — D-Scanner is a tool for analyzing D source code.

<a name="elixir" />
<h2>Elixir</h2>

* [credo](https://github.com/rrrene/credo) ⭐ 5,141 | 🐛 30 | 🌐 Elixir | 📅 2026-02-12 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,779 | 🐛 78 | 🌐 Elixir | 📅 2025-11-06 — Mix tasks to simplify use of Dialyzer in Elixir projects.

* [sobelow](https://github.com/nccgroup/sobelow) ⭐ 1,774 | 🐛 37 | 🌐 Elixir | 📅 2024-08-20 — Security-focused static analysis for the Phoenix Framework.
...
* [elvis](https://github.com/inaka/elvis) ⭐ 429 | 🐛 6 | 🌐 Erlang | 📅 2026-02-11 — Erlang Style Reviewer.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 321 | 🐛 90 | 🌐 F# | 📅 2026-02-12 — Lint tool for F#.
...
* [i-Code CNES for Fortran](https://github.com/lequal/i-CodeCNES) ⭐ 63 | 🐛 48 | 🌐 Fortran | 📅 2025-09-16 — An open source static code analysis tool for Fortran 77, Fortran 90 and Shell.

<a name="go" />
<h2>Go</h2>

* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,070 | 🐛 141 | 🌐 Go | 📅 2026-02-12 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,850 | 🐛 29 | 🌐 Go | 📅 2025-12-20 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) ⭐ 3,135 | 🐛 30 | 🌐 Go | 📅 2018-10-27 — Concurrently runs many linters and normalises their output to a report.

* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,472 | 🐛 13 | 🌐 Go | 📅 2025-06-30 — Check that error return values are used.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,035 | 🐛 145 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.

* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,533 | 🐛 10 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.

* [misspell](https://github.com/client9/misspell) ⚠️ Archived — Finds commonly misspelled English words.

* [structslop](https://github.com/orijtech/structslop) ⭐ 833 | 🐛 11 | 🌐 Go | 📅 2024-02-08 — Static analyzer for Go that recommends struct field rearrangements to provide for maximum space/allocation efficiency

* [prealloc](https://github.com/alexkohler/prealloc) ⭐ 662 | 🐛 5 | 🌐 Go | 📅 2026-02-12 — Finds slice declarations that could potentially be preallocated.

* [unparam](https://github.com/mvdan/unparam) ⭐ 568 | 🐛 10 | 🌐 Go | 📅 2025-10-27 — Find unused function parameters.
...
* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 451 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.

* [unconvert](https://github.com/mdempsky/unconvert) ⭐ 388 | 🐛 8 | 🌐 Go | 📅 2025-02-16 — Detect redundant type conversions.

* [errwrap](https://github.com/fatih/errwrap) ⭐ 380 | 🐛 1 | 🌐 Go | 📅 2025-04-07 — Wrap and fix Go errors with the new %w verb directive.  This tool analyzes fmt.Errorf() calls and reports calls that contain a verb directive that  is different than the new %w verb directive introduced in Go v1.13.  It's also capable of rewriting calls to use the new %w wrap verb directive.

* [go-consistent](https://github.com/Quasilyte/go-consistent) ⭐ 363 | 🐛 20 | 🌐 Go | 📅 2025-05-29 — Analyzer that helps you to make your Go programs more consistent.

* [wsl](https://github.com/bombsimon/wsl) ⭐ 340 | 🐛 3 | 🌐 Go | 📅 2026-02-10 — Enforces empty lines at the right places.

* [bodyclose](https://github.com/timakin/bodyclose) ⭐ 323 | 🐛 27 | 🌐 Go | 📅 2026-01-29 — Checks whether HTTP response body is closed.

* [goconst](https://github.com/jgautheron/goconst) ⭐ 314 | 🐛 1 | 🌐 Go | 📅 2025-05-22 — Finds repeated strings that could be replaced by a constant.

* [nakedret](https://github.com/alexkohler/nakedret) ⭐ 132 | 🐛 2 | 🌐 Go | 📅 2026-02-01 — Finds naked returns.

* [nargs](https://github.com/alexkohler/nargs) ⭐ 86 | 🐛 0 | 🌐 Go | 📅 2025-05-15 — Finds unused arguments in function declarations.

* [dogsled](https://github.com/alexkohler/dogsled) ⭐ 73 | 🐛 1 | 🌐 Go | 📅 2024-03-29 — Finds assignments/declarations with too many blank identifiers.

* [lll](https://github.com/walle/lll) ⭐ 70 | 🐛 7 | 🌐 Go | 📅 2022-06-04 — Report long lines.

* [deadcode](https://github.com/tsenart/deadcode) ⭐ 53 | 🐛 8 | 🌐 Go | 📅 2018-10-28 — Finds unused code.

* [flen](https://github.com/lafolle/flen) ⭐ 51 | 🐛 3 | 🌐 Go | 📅 2018-03-11 — Get info on length of functions in a Go package.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,572 | 🐛 291 | 🌐 Haskell | 📅 2025-12-27 — HLint is a tool for suggesting possible improvements to Haskell code.

* [Weeder](https://github.com/ocharles/weeder) ⭐ 184 | 🐛 40 | 🌐 Haskell | 📅 2025-12-23 — A tool for detecting dead exports or package imports in Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,069 | 🐛 165 | 🌐 Java | 📅 2026-02-05 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,007 | 🐛 132 | 🌐 Java | 📅 2026-02-13 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,128 | 🐛 428 | 🌐 Java | 📅 2026-02-11 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 509 | 🐛 62 | 🌐 Java | 📅 2026-01-15 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.

* [ck](https://github.com/mauricioaniche/ck) ⭐ 442 | 🐛 31 | 🌐 Java | 📅 2026-01-22 — Calculates Chidamber and Kemerer object-oriented metrics by processing the source Java files.

* [forbidden-apis](https://github.com/policeman-tools/forbidden-apis) ⭐ 359 | 🐛 30 | 🌐 Java | 📅 2025-10-05 — Detects and forbids invocations of specific method/class/field (like reading from a text stream without a charset). Maven/Gradle/Ant compatible.

* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 154 | 🐛 10 | 🌐 Java | 📅 2025-11-15 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,377 | 🐛 2 | 🌐 Rust | 📅 2026-02-11 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,949 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,658 | 🐛 6 | 🌐 JavaScript | 📅 2026-01-01 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,377 | 🐛 2 | 🌐 Rust | 📅 2026-02-11 — The JavaScript Code Quality Tool.

* [Polymer-analyzer](https://github.com/Polymer/tools/tree/master/packages/analyzer) ⭐ 436 | 🐛 839 | 🌐 TypeScript | 📅 2026-01-24 — A static analysis framework for Web Components.

* [escomplex](https://github.com/jared-stilwell/escomplex) ⭐ 271 | 🐛 21 | 🌐 JavaScript | 📅 2023-12-12 — Software complexity analysis of JavaScript-family abstract syntax trees.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 847 | 🐛 93 | 🌐 Julia | 📅 2026-02-02 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 158 | 🐛 64 | 🌐 Julia | 📅 2026-02-11 — Static Code Analysis for Julia
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 438 | 🐛 41 | 🌐 Lua | 📅 2025-08-01 — A tool for linting and static analysis of Lua code.
...
* [VeriFast](https://github.com/verifast/verifast) ⭐ 472 | 🐛 109 | 🌐 Rust | 📅 2026-02-11 — A tool for modular formal verification of correctness properties of single-threaded and multithreaded  C and Java programs annotated with preconditions and postconditions written in separation logic.  To express rich specifications, the programmer can define inductive datatypes,  primitive recursive pure functions over these datatypes, and abstract separation logic predicates.

* [Sys](https://github.com/PLSysSec/sys) ⭐ 236 | 🐛 13 | 🌐 LLVM | 📅 2022-03-14 — A static/symbolic Tool for finding bugs in (browser) code. It uses the LLVM AST to find bugs like uninitialized memory access.
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 591 | 🐛 18 | 🌐 PHP | 📅 2026-01-28 — Fast detection of composer dependency issues.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,792 | 🐛 269 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,461 | 🐛 85 | 🌐 PHP | 📅 2026-02-11.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,303 | 🐛 109 | 🌐 PHP | 📅 2026-02-02 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,604 | 🐛 799 | 🌐 PHP | 📅 2026-02-09 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,578 | 🐛 71 | 🌐 PHP | 📅 2025-11-12 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,270 | 🐛 5 | 🌐 PHP | 📅 2026-02-03 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,890 | 🐛 28 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.

* [phploc](https://github.com/sebastianbergmann/phploc) ⚠️ Archived — A tool for quickly measuring the size and analyzing the structure of a PHP project.

* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,296 | 🐛 3 | 🌐 Dockerfile | 📅 2026-02-09 — Many tools for PHP static analysis in one container.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 866 | 🐛 40 | 🌐 PHP | 📅 2026-02-11 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.

* [phpmnd](https://github.com/povils/phpmnd) ⭐ 579 | 🐛 22 | 🌐 PHP | 📅 2026-02-12 — Helps to detect magic numbers.

* [dephpend](https://github.com/mihaeu/dephpend) ⭐ 537 | 🐛 5 | 🌐 PHP | 📅 2026-01-28 — Dependency analysis tool.

* [PHP Semantic Versioning Checker](https://github.com/tomzx/php-semver-checker) ⭐ 434 | 🐛 39 | 🌐 PHP | 📅 2026-02-05 — Suggests a next version according to semantic versioning.
...
* [Parse](https://github.com/psecio/parse) ⭐ 379 | 🐛 18 | 🌐 PHP | 📅 2018-08-07 — A Static Security Scanner.

* [Progpilot](https://github.com/designsecurity/progpilot) ⭐ 359 | 🐛 4 | 🌐 PHP | 📅 2025-08-17 — A static analysis tool for security purposes.

* [parallel-lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) ⭐ 345 | 🐛 30 | 🌐 PHP | 📅 2025-12-15 — This tool checks syntax of PHP files faster than serial check with a fancier output.

* [phpqa - jmolivas](https://github.com/jmolivas/phpqa) ⭐ 325 | 🐛 4 | 🌐 PHP | 📅 2017-12-07 — PHPQA all-in-one Analyzer CLI tool.

* [Tuli](https://github.com/ircmaxell/Tuli) ⭐ 171 | 🐛 7 | 🌐 PHP | 📅 2015-10-23 — A static analysis engine.

* [PHP Assumptions](https://github.com/rskuipers/php-assumptions) ⭐ 165 | 🐛 9 | 🌐 PHP | 📅 2025-03-22 — Checks for weak assumptions.

* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 126 | 🐛 19 | 🌐 PHP | 📅 2026-02-10 — Reflection library to do Static Analysis for PHP Projects

* [twig-lint](https://github.com/asm89/twig-lint) ⭐ 117 | 🐛 14 | 🌐 PHP | 📅 2021-11-19 — twig-lint is a lint tool for your twig files.
...
* [zarn](https://github.com/htrgouvea/zarn) ⭐ 55 | 🐛 5 | 🌐 Perl | 📅 2026-02-07 — A lightweight static security analysis tool for modern Perl Apps

<a name="python" />
<h2>Python</h2>

* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,220 | 🐛 206 | 🌐 Python | 📅 2026-02-07 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,989 | 🐛 65 | 🌐 Python | 📅 2026-02-11.

* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,323 | 🐛 55 | 🌐 Python | 📅 2025-11-25 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,757 | 🐛 23 | 🌐 Python | 📅 2025-12-22 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,525 | 🐛 33 | 🌐 Python | 📅 2025-09-17 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,064 | 🐛 33 | 🌐 Python | 📅 2026-02-10 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,933 | 🐛 50 | 🌐 Python | 📅 2024-10-20.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,269 | 🐛 47 | 🌐 Python | 📅 2026-01-02 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,195 | 🐛 63 | 🌐 Python | 📅 2026-02-09 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.

* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 952 | 🐛 47 | 🌐 Python | 📅 2026-01-23 — Autoflake removes unused imports and unused variables from Python code.

* [bellybutton](https://github.com/hchasestevens/bellybutton) ⭐ 278 | 🐛 11 | 🌐 Python | 📅 2023-07-27 — A linting engine supporting custom project-specific rules.

* [pyroma](https://github.com/regebro/pyroma) ⭐ 231 | 🐛 7 | 🌐 Python | 📅 2025-12-09 — Rate how well a Python project complies with the best practices of the Python packaging ecosystem, and list issues that could be improved.
...
* [Dlint](https://github.com/dlint-py/dlint) ⭐ 174 | 🐛 23 | 🌐 Python | 📅 2026-01-07 — A tool for ensuring Python code is secure.

* [Dodgy](https://github.com/landscapeio/dodgy) ⭐ 128 | 🐛 11 | 🌐 Python | 📅 2021-08-29 — Dodgy is a very basic tool to run against your codebase to search for "dodgy" looking values. It is a series of simple regular expressions designed to detect things such as accidental SCM diff checkins, or passwords or secret keys hard coded into files.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,270 | 🐛 303 | 🌐 R | 📅 2026-02-06 — Static Code Analysis for R.

* [R Language Server](https://github.com/REditorSupport/languageserver/) ⭐ 654 | 🐛 137 | 🌐 R | 📅 2026-02-12 — Provides code completion, refactoring, folding, diagnostics (with lintr), and more for R.

* [CodeDepends](https://github.com/duncantl/CodeDepends) ⭐ 93 | 🐛 25 | 🌐 R | 📅 2025-12-19 — Static Code Analysis for R.

* [flowR](https://github.com/flowr-analysis/flowr) ⭐ 85 | 🐛 300 | 🌐 TypeScript | 📅 2026-02-12 — A [program slicer](https://github.com/flowr-analysis/flowr/wiki/Terminology#program-slice) ⭐ 85 | 🐛 300 | 🌐 TypeScript | 📅 2026-02-12 and [dataflow analyzer](https://en.wikipedia.org/wiki/Data-flow_analysis) for the [R](https://www.r-project.org/) programming language. Its slicer allows you to reduce a complicated program just to the parts related for a specific task (e.g., the generation of a single or collection of plots, a significance test, ...). The dataflow analysis provides you with a detailed view on the semantics of the R code which can greatly improve other analyses. To use *flowR*, check out the [Visual Studio Code extension](https://marketplace.visualstudio.com/items?itemName=code-inspect.vscode-flowr), the [RStudio Addin](https://github.com/flowr-analysis/rstudio-addin-flowr) ⭐ 5 | 🐛 17 | 🌐 R | 📅 2025-05-26, the [Docker image](https://hub.docker.com/r/eagleoutice/flowr), or the [R package](https://github.com/flowr-analysis/flowr-r-adapter) ⭐ 3 | 🐛 10 | 🌐 R | 📅 2025-05-26.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 360 | 🐛 144 | 🌐 Go | 📅 2026-02-12 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,884 | 🐛 39 | 🌐 Ruby | 📅 2026-02-12 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,739 | 🐛 52 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,052 | 🐛 16 | 🌐 Ruby | 📅 2026-02-13.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,907 | 🐛 26 | 🌐 Ruby | 📅 2026-01-12 — Identify database issues before they hit production.

* [Fasterer](https://github.com/DamirSvrtan/fasterer) ⭐ 1,817 | 🐛 10 | 🌐 Ruby | 📅 2024-06-14 — Common Ruby idioms checker.

* [Steep](https://github.com/soutaro/steep) ⭐ 1,471 | 🐛 180 | 🌐 Ruby | 📅 2026-02-12 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,162 | 🐛 9 | 🌐 Ruby | 📅 2025-12-10 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.

* [rufo](https://github.com/ruby-formatter/rufo) ⭐ 932 | 🐛 34 | 🌐 Ruby | 📅 2025-12-25 — An opinionated ruby formatter, intended to be used via the command line as a text-editor plugin, to autoformat files on save or on demand.

* [Traceroute](https://github.com/amatsuda/traceroute) ⭐ 905 | 🐛 16 | 🌐 Ruby | 📅 2025-04-29 — A Rake task gem that helps you find the unused routes and controller actions for your Rails 3+ app.
...
* [ERB Lint](https://github.com/Shopify/erb-lint) ⭐ 739 | 🐛 88 | 🌐 Ruby | 📅 2026-02-09 — Lint your ERB or HTML files

* [Rubrowser](https://github.com/blazeeboy/rubrowser) ⭐ 644 | 🐛 2 | 🌐 JavaScript | 📅 2023-08-19 — Ruby classes interactive dependency graph generator.

* [Skunk](https://github.com/fastruby/skunk) ⭐ 539 | 🐛 9 | 🌐 Ruby | 📅 2026-02-06 — A SkunkScore Calculator for Ruby Code -- Find the most complicated code without test coverage!

* [pelusa](https://github.com/codegram/pelusa) ⭐ 437 | 🐛 0 | 🌐 Ruby | 📅 2015-01-07 — Static analysis Lint-type tool to improve your OO Ruby code.

* [htmlbeautifier](https://github.com/threedaymonk/htmlbeautifier) ⭐ 370 | 🐛 18 | 🌐 Ruby | 📅 2024-02-13 — A normaliser/beautifier for HTML that also understands embedded Ruby. Ideal for tidying up Rails templates.

* [Roodi](https://github.com/roodi/roodi) ⭐ 277 | 🐛 2 | 🌐 Ruby | 📅 2021-02-11 — Roodi stands for Ruby Object Oriented Design Inferometer. It parses your Ruby code and warns you about design issues you have based on the checks that it has configured.

* [ERB::Formatter](https://github.com/nebulab/erb-formatter) ⭐ 194 | 🐛 32 | 🌐 Ruby | 📅 2025-06-19 — Format ERB files with speed and precision.

* [Fukuzatsu](https://github.com/CoralineAda/fukuzatsu) ⭐ 32 | 🐛 2 | 🌐 Ruby | 📅 2018-12-18 — A tool for measuring code complexity in Ruby class files. Its analysis generates scores based on cyclomatic complexity algorithms with no added "opinions".
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,030 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 2,903 | 🐛 484 | 🌐 Rust | 📅 2026-02-11 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,078 | 🐛 40 | 🌐 Rust | 📅 2025-12-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.

* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,561 | 🐛 52 | 🌐 Rust | 📅 2026-01-11 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,080 | 🐛 100 | 📅 2026-02-13.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 921 | 🐛 27 | 🌐 Rust | 📅 2026-02-09 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code

* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 649 | 🐛 38 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.

* [cargo-spellcheck](https://github.com/drahnr/cargo-spellcheck) ⭐ 357 | 🐛 58 | 🌐 Rust | 📅 2026-02-03 — Checks all your documentation for spelling and grammar mistakes  with hunspell (ready) and languagetool (preview)
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,734 | 🐛 910 | 🌐 Rust | 📅 2026-02-12 — A tool for formatting Rust code according to style guidelines.

* [RustViz](https://github.com/rustviz/rustviz) ⭐ 2,820 | 🐛 24 | 🌐 HTML | 📅 2024-02-13 — RustViz is a tool that generates visualizations  from simple Rust programs to assist users in better  understanding the Rust Lifetime and Borrowing mechanism. It generates SVG files with graphical indicators that integrate  with mdbook to render visualizations of data-flow in Rust programs.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 796 | 🐛 16 | 🌐 Rust | 📅 2025-11-09 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [lockbud](https://github.com/BurtonQin/lockbud) ⭐ 584 | 🐛 27 | 🌐 Rust | 📅 2025-10-21 — Statically detects Rust deadlocks bugs. It currently detects two common kinds of deadlock bugs: doublelock and locks in conflicting order. It will print bugs in JSON format together with the source code location and an explanation of each bug.
...
* [sqlint](https://github.com/purcell/sqlint) ⭐ 437 | 🐛 0 | 🌐 Ruby | 📅 2025-11-22 — Simple SQL linter.

* [sleek](https://github.com/nrempel/sleek) ⭐ 274 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-18 — Sleek is a CLI tool for formatting SQL.  It helps you maintain a consistent style across your SQL code, enhancing readability and productivity. The heavy lifting is done by the sqlformat crate.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 126 | 🐛 5 | 🌐 Python | 📅 2026-02-11 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 554 | 🐛 51 | 🌐 Scala | 📅 2026-02-10 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,748 | 🐛 8 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.

* [bashate](https://github.com/openstack/bashate) ⭐ 395 | 🐛 0 | 🌐 Python | 📅 2024-11-26 — Code style enforcement for bash programs. The output format aims to follow pycodestyle (pep8) default output format.

* [i-Code CNES for Shell](https://github.com/lequal/i-CodeCNES) ⭐ 63 | 🐛 48 | 🌐 Fortran | 📅 2025-09-16 — An open source static code analysis tool for Shell and Fortran (77 and 90).

* [kmdr](https://github.com/ediardo/kmdr-cli) ⭐ 18 | 🐛 0 | 📅 2022-02-27 — CLI tool for learning commands from your terminal. kmdr delivers a break down of commands with every attribute explained.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,694 | 🐛 332 | 🌐 Swift | 📅 2026-02-10 — A library and command-line formatting tool for reformatting Swift code.
...
* [tclchecker](https://github.com/ActiveState/tdk/blob/master/docs/3.0/TDK_3.0_Checker.txt) ⭐ 81 | 🐛 5 | 🌐 Tcl | 📅 2024-05-17 — A static syntax analysis module (as part of [TDK](https://github.com/ActiveState/tdk) ⭐ 81 | 🐛 5 | 🌐 Tcl | 📅 2024-05-17).

<a name="typescript" />
<h2>TypeScript</h2>

* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,094 | 🐛 302 | 🌐 TypeScript | 📅 2026-02-13 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,773 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-12 — Linter for Angular projects

* [TypeScript Call Graph](https://github.com/whyboris/TypeScript-Call-Graph) ⭐ 282 | 🐛 9 | 🌐 JavaScript | 📅 2025-10-26 — CLI to generate an interactive graph of functions and calls from your TypeScript files

* [ENRE-ts](https://github.com/xjtu-enre/ENRE-ts) ⭐ 15 | 🐛 1 | 🌐 TypeScript | 📅 2025-09-30 — ENRE (ENtity Relationship Extractor) is a tool for extraction of code entity dependencies or relationships from source code. ENRE-ts is a ENtity Relationship Extractor for ECMAScript and TypeScript based on @babel/parser.
...
* [svls](https://github.com/dalance/svls) ⭐ 560 | 🐛 26 | 🌐 Rust | 📅 2026-02-12 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 352 | 🐛 77 | 🌐 TypeScript | 📅 2026-02-12 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [Twiggy](https://github.com/rustwasm/twiggy) ⭐ 1,419 | 🐛 47 | 🌐 Rust | 📅 2025-10-20 — Analyzes a binary's call graph to profile code size. The goal is to slim down wasm binary size.

* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 69 | 🐛 4 | 🌐 Rust | 📅 2026-02-13 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 31,892 | 🐛 215 | 🌐 Go | 📅 2026-02-12 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 26,893 | 🐛 93 | 🌐 JavaScript | 📅 2026-02-12 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 18,962 | 🐛 414 | 🌐 Rust | 📅 2026-02-13 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,960 | 🐛 585 | 🌐 Vim Script | 📅 2026-02-12 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,231 | 🐛 1,292 | 🌐 CodeQL | 📅 2026-02-12 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,232 | 🐛 141 | 🌐 TypeScript | 📅 2026-01-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.

* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,385 | 🐛 21 | 🌐 C# | 📅 2026-02-06 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,956 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,657 | 🐛 13 | 🌐 Ruby | 📅 2026-02-09 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,560 | 🐛 27 | 🌐 Go | 📅 2026-02-09 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.

* [weggli](https://github.com/googleprojectzero/weggli) ⭐ 2,475 | 🐛 47 | 🌐 Rust | 📅 2024-07-12 — A fast and robust semantic search tool for C and C++ codebases. It is designed to help security researchers identify interesting functionality in large codebases.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,266 | 🐛 56 | 🌐 Python | 📅 2026-02-03 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.

* [TscanCode](https://github.com/Tencent/TscanCode) ⭐ 2,113 | 🐛 57 | 🌐 C++ | 📅 2023-12-25 — A fast and accurate static analysis solution for C/C++, C#, Lua codes provided by Tencent. Using GPLv3 license.

* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,947 | 🐛 193 | 📅 2026-02-12 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,668 | 🐛 1,056 | 📅 2026-02-09 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 970 | 🐛 65 | 🌐 C# | 📅 2026-02-12 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [ShiftLeft Scan](https://github.com/ShiftLeftSecurity/sast-scan) ⭐ 865 | 🐛 49 | 🌐 Python | 📅 2023-09-01 — Scan is a free open-source DevSecOps platform for detecting security issues in source code and dependencies. It supports a broad range of languages and CI/CD pipelines.

* [WALA](https://github.com/wala/WALA) ⭐ 833 | 🐛 147 | 🌐 Java | 📅 2026-02-03 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-12 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [sqlvet](https://github.com/houqp/sqlvet) ⭐ 497 | 🐛 10 | 🌐 Go | 📅 2025-12-12 — Performs static analysis on raw SQL queries in your Go code base to surface potential runtime errors. It checks for SQL syntax error, identifies unsafe queries that could potentially lead to SQL injections makes sure column count matches value count in INSERT statements and validates table- and column names.

* [todocheck](https://github.com/preslavmihaylov/todocheck) ⭐ 437 | 🐛 13 | 🌐 Go | 📅 2025-08-02 — Linter for integrating annotated TODOs with your issue trackers

* [callGraph](https://github.com/koknat/callGraph) ⭐ 324 | 🐛 6 | 🌐 Perl | 📅 2024-11-20 — Statically generates a call graph image and displays it on screen.

* [Depends](https://github.com/multilang-depends/depends) ⭐ 242 | 🐛 12 | 🌐 Java | 📅 2026-02-10 — Analyses the comprehensive dependencies of code elements for Java, C/C++, Ruby.

* [relint](https://github.com/codingjoe/relint) ⭐ 65 | 🐛 0 | 🌐 Python | 📅 2025-12-15 — A static file linter that allows you to write custom rules using regular expressions (RegEx).

* [OpenStaticAnalyzer](https://github.com/sed-inf-u-szeged/OpenStaticAnalyzer) ⭐ 48 | 🐛 2 | 🌐 C++ | 📅 2022-11-09 — OpenStaticAnalyzer is a source code analyzer tool, which can perform deep static analysis of the source code of complex systems.

* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 36 | 🐛 6 | 🌐 Go | 📅 2026-02-12 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [LangLint](https://github.com/HzaCode/Langlint) ⭐ 32 | 🐛 1 | 🌐 Rust | 📅 2025-12-17 — Automated translation platform for code comments and docstrings across 20+ file types. Eliminates language barriers in international software collaboration. Supports 100+ language pairs with syntax protection. Integrates into CI/CD pipelines like Ruff. 10-20x faster with concurrent processing.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 22 | 🐛 1 | 🌐 Rust | 📅 2026-02-13 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [alquitran](https://github.com/ferivoz/alquitran) ⭐ 22 | 🐛 0 | 🌐 Rust | 📅 2025-03-27 — Inspects tar archives and tries to spot portability issues in regard  to POSIX 2017 pax specification and common tar implementations.
...
* [angr](https://github.com/angr/angr) ⭐ 8,491 | 🐛 587 | 🌐 Python | 📅 2026-02-12 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,365 | 🐛 61 | 🌐 C++ | 📅 2026-01-31 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,106 | 🐛 6 | 🌐 YARA | 📅 2026-01-30 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 839 | 🐛 154 | 🌐 C# | 📅 2026-02-12 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 796 | 🐛 16 | 🌐 Rust | 📅 2025-11-09 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 570 | 🐛 2 | 🌐 C++ | 📅 2026-02-12 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.

* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 567 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Jakstab](https://github.com/jkinder/jakstab) ⭐ 163 | 🐛 3 | 🌐 Java | 📅 2019-12-10 — Jakstab is an Abstract Interpretation-based, integrated disassembly and static analysis framework for designing analyses on executables and recovering reliable control flow graphs.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,171 | 🐛 31 | 🌐 Go | 📅 2026-02-09 — Linter / Analyzer for Makefiles.
...
* [CSScomb](https://github.com/csscomb/csscomb.js) ⭐ 3,328 | 🐛 108 | 🌐 JavaScript | 📅 2023-01-03 — A coding style formatter for CSS. Supports own configurations to make style sheets beautiful and consistent.
...
* [gixy](https://github.com/yandex/gixy) ⭐ 8,551 | 🐛 57 | 🌐 Python | 📅 2024-07-28 — A tool to analyze Nginx configuration. The main goal is to prevent misconfiguration and automate flaw detection.

<a name="configmanagement" />
<h2>Configuration Management</h2>

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,952 | 🐛 14 | 🌐 Go | 📅 2025-11-10 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [tflint](https://github.com/wata727/tflint) ⭐ 5,614 | 🐛 28 | 🌐 Go | 📅 2026-02-09 — A Terraform linter for detecting errors that can not be detected by `terraform plan`.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,610 | 🐛 102 | 🌐 Python | 📅 2026-02-12 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,366 | 🐛 49 | 🌐 Rust | 📅 2026-02-11 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.

* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,303 | 🐛 83 | 🌐 Ruby | 📅 2024-08-01 — A linter for AWS CloudFormation templates.

* [metadata-json-lint](https://github.com/voxpupuli/metadata-json-lint) ⭐ 31 | 🐛 12 | 🌐 Ruby | 📅 2026-01-06 — Tool to check the validity of Puppet metadata.json files.

* [terrascan](https://github.com/cesar-rodriguez/terrascan) ⭐ 2 | 🐛 0 | 📅 2025-11-20 — Collection of security and best practice tests for static code analysis of Terraform templates.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 11,945 | 🐛 249 | 🌐 Haskell | 📅 2026-01-27 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,543 | 🐛 358 | 🌐 Go | 📅 2026-02-12 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,926 | 🐛 50 | 🌐 Go | 📅 2026-02-12 — Vulnerability Static Analysis for Containers.

* [krane](https://github.com/appvia/krane) ⭐ 734 | 🐛 54 | 🌐 Ruby | 📅 2026-01-22 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,582 | 🐛 174 | 🌐 Rust | 📅 2026-01-31 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 76 | 🐛 5 | 🌐 Python | 📅 2026-02-12 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [gherkin-lint](https://github.com/vsiakka/gherkin-lint) ⭐ 195 | 🐛 76 | 🌐 JavaScript | 📅 2024-08-19 — A linter for the Gherkin-Syntax written in Javascript.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,395 | 🐛 79 | 🌐 Go | 📅 2026-02-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,926 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,610 | 🐛 6 | 🌐 Go | 📅 2026-02-03 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.

* [krane](https://github.com/appvia/krane) ⭐ 734 | 🐛 54 | 🌐 Ruby | 📅 2026-01-22 — Krane is a simple Kubernetes RBAC static analysis tool.
  It identifies potential security risks in K8s RBAC design and makes suggestions on how to mitigate them. Krane dashboard presents current RBAC security posture and lets you navigate through its definition.

* [clusterlint](https://github.com/digitalocean/clusterlint) ⭐ 583 | 🐛 11 | 🌐 Go | 📅 2026-02-04 — Clusterlint queries live Kubernetes clusters for resources, executes common and  platform specific checks against these resources and provides actionable feedback to cluster operators.  It is a non invasive tool that is run externally. Clusterlint does not alter the resource configurations.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,395 | 🐛 79 | 🌐 Go | 📅 2026-02-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,833 | 🐛 79 | 🌐 JavaScript | 📅 2026-02-13 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,005 | 🐛 154 | 🌐 Ruby | 📅 2025-12-01 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 96 | 🐛 20 | 🌐 Rust | 📅 2026-02-12 — Format markdown code blocks using your favorite code formatters.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,223 | 🐛 241 | 🌐 Java | 📅 2026-02-12 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 820 | 🐛 46 | 🌐 Rust | 📅 2026-02-13 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 715 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)

<a name="nodejs" />
<h2>Node.js</h2>

* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 839 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-25 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 161 | 🐛 88 | 🌐 Python | 📅 2026-02-11 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 673 | 🐛 53 | 🌐 Go | 📅 2026-01-14 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 24,886 | 🐛 345 | 🌐 Go | 📅 2026-01-08 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,543 | 🐛 358 | 🌐 Go | 📅 2026-02-12 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,420 | 🐛 137 | 🌐 Python | 📅 2025-03-13 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,539 | 🐛 3 | 🌐 Java | 📅 2026-02-12 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,952 | 🐛 14 | 🌐 Go | 📅 2025-11-10 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,262 | 🐛 383 | 🌐 Go | 📅 2026-02-10 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,132 | 🐛 427 | 🌐 Python | 📅 2026-02-12 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,201 | 🐛 123 | 🌐 Python | 📅 2026-02-09 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [haml-lint](https://github.com/sds/haml-lint) ⭐ 334 | 🐛 13 | 🌐 Ruby | 📅 2026-02-03 — Tool for writing clean and consistent HAML.

* [ember-template-lint](https://github.com/ember-template-lint/ember-template-lint) ⭐ 266 | 🐛 177 | 🌐 JavaScript | 📅 2025-12-01 — Linter for Ember or Handlebars templates.

* [slim-lint](https://github.com/sds/slim-lint) ⭐ 222 | 🐛 21 | 🌐 Ruby | 📅 2026-02-02 — Configurable tool for analyzing Slim templates.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 50 | 🐛 24 | 🌐 Python | 📅 2026-02-10 — A set of utilities for working with PO files to ease development and improve quality.
...
* [write-good](https://github.com/btford/write-good) ⭐ 5,058 | 🐛 24 | 🌐 JavaScript | 📅 2025-03-10 — A linter with a focus on eliminating "weasel words".

* [proselint](https://github.com/amperser/proselint) ⭐ 4,506 | 🐛 241 | 🌐 JavaScript | 📅 2026-01-26 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,330 | 🐛 250 | 🌐 Python | 📅 2026-02-06 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,715 | 🐛 589 | 🌐 Go | 📅 2026-01-20 — A collection of tools and libraries for working with Go code, including linters and static analysis
* [php-static-analysis-tools](https://github.com/exakat/php-static-analysis-tools) ⭐ 2,870 | 🐛 5 | 📅 2025-01-28 — A reviewed list of useful PHP static analysis tools
* [linters](https://github.com/mcandre/linters) ⭐ 349 | 🐛 59 | 📅 2026-02-11 — An introduction to static code analysis
