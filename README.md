...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,478 | 🐛 27 | 🌐 Rust | 📅 2026-03-23
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,809 | 🐛 71 | 🌐 Python | 📅 2026-04-06 — Automated C++ checker that follows Google's style guide.
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,247 | 🐛 36 | 🌐 C# | 📅 2026-04-05 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,105 | 🐛 3 | 🌐 C# | 📅 2026-04-02 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 901 | 🐛 244 | 🌐 C# | 📅 2026-04-03 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,155 | 🐛 27 | 🌐 Elixir | 📅 2026-04-03 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,186 | 🐛 138 | 🌐 Go | 📅 2026-04-05 — A tool for posting review comments from any linter in any code hosting service.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,477 | 🐛 14 | 🌐 Go | 📅 2026-02-26 — Check that error return values are used.
...
* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,553 | 🐛 10 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.
...
* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 460 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.
...
* [wsl](https://github.com/bombsimon/wsl) ⭐ 348 | 🐛 5 | 🌐 Go | 📅 2026-04-06 — Enforces empty lines at the right places.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,105 | 🐛 165 | 🌐 Java | 📅 2026-04-06 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,030 | 🐛 143 | 🌐 Java | 📅 2026-04-03 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 429 | 🌐 Java | 📅 2026-04-07 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,478 | 🐛 27 | 🌐 Rust | 📅 2026-03-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,972 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-02 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,669 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,478 | 🐛 27 | 🌐 Rust | 📅 2026-03-23 — The JavaScript Code Quality Tool.
...
* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-04-07 — Static Code Analysis for Julia
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 440 | 🐛 42 | 🌐 Lua | 📅 2026-03-16 — A tool for linting and static analysis of Lua code.
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 609 | 🐛 18 | 🌐 PHP | 📅 2026-01-28 — Fast detection of composer dependency issues.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,424 | 🐛 65 | 🌐 PHP | 📅 2026-02-26 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,779 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,487 | 🐛 86 | 🌐 PHP | 📅 2026-04-07.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,355 | 🐛 120 | 🌐 PHP | 📅 2026-04-03 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,610 | 🐛 792 | 🌐 PHP | 📅 2026-04-06 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,589 | 🐛 69 | 🌐 PHP | 📅 2026-02-23 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,279 | 🐛 8 | 🌐 PHP | 📅 2026-03-30 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,910 | 🐛 29 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 887 | 🐛 33 | 🌐 PHP | 📅 2026-04-05 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,356 | 🐛 249 | 🌐 Python | 📅 2026-03-29 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,770 | 🐛 24 | 🌐 Python | 📅 2026-04-06 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,076 | 🐛 33 | 🌐 Python | 📅 2026-04-06 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,960 | 🐛 50 | 🌐 Python | 📅 2024-10-20.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,890 | 🐛 41 | 🌐 Ruby | 📅 2026-03-27 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,745 | 🐛 58 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,057 | 🐛 25 | 🌐 Ruby | 📅 2026-03-30.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,481 | 🐛 221 | 🌐 Ruby | 📅 2026-04-07 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,012 | 🐛 472 | 🌐 Rust | 📅 2026-04-06 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,097 | 🐛 101 | 📅 2026-04-06.
...
* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 653 | 🐛 40 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,770 | 🐛 313 | 🌐 Swift | 📅 2026-04-06 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,190 | 🐛 302 | 🌐 TypeScript | 📅 2026-04-06 — TypeScript language extension for eslint.
...
* [svls](https://github.com/dalance/svls) ⭐ 570 | 🐛 26 | 🌐 Rust | 📅 2026-04-02 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 364 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-06 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,391 | 🐛 250 | 🌐 Go | 📅 2026-04-03 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,140 | 🐛 105 | 🌐 JavaScript | 📅 2026-04-07 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,567 | 🐛 624 | 🌐 Rust | 📅 2026-04-07 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,981 | 🐛 597 | 🌐 Vim Script | 📅 2026-04-01 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,435 | 🐛 1,378 | 🌐 CodeQL | 📅 2026-04-06 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,975 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,612 | 🐛 25 | 🌐 Go | 📅 2026-04-06 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,326 | 🐛 52 | 🌐 Python | 📅 2026-03-30 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.

* [TscanCode](https://github.com/Tencent/TscanCode) ⭐ 2,117 | 🐛 57 | 🌐 C++ | 📅 2023-12-25 — A fast and accurate static analysis solution for C/C++, C#, Lua codes provided by Tencent. Using GPLv3 license.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,670 | 🐛 1,056 | 📅 2026-04-06 — Roslyn-based implementation of FxCop analyzers.
...
* [Skylos](https://github.com/duriantaco/skylos) ⭐ 362 | 🐛 4 | 🌐 Python | 📅 2026-04-07 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.

* [callGraph](https://github.com/koknat/callGraph) ⭐ 330 | 🐛 6 | 🌐 Perl | 📅 2024-11-20 — Statically generates a call graph image and displays it on screen.

* [Depends](https://github.com/multilang-depends/depends) ⭐ 248 | 🐛 12 | 🌐 Java | 📅 2026-02-23 — Analyses the comprehensive dependencies of code elements for Java, C/C++, Ruby.
...
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 107 | 🐛 8 | 🌐 Rust | 📅 2026-04-07 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.
...
* [angr](https://github.com/angr/angr) ⭐ 8,588 | 🐛 607 | 🌐 Python | 📅 2026-04-07 — Binary code analysis tool that also supports symbolic execution.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-04-06 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,185 | 🐛 31 | 🌐 Go | 📅 2026-03-31 — Linter / Analyzer for Makefiles.
...
* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,975 | 🐛 14 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,609 | 🐛 67 | 🌐 Python | 📅 2026-04-01 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,373 | 🐛 47 | 🌐 Rust | 📅 2026-04-06 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Grype](https://github.com/anchore/grype) ⭐ 11,965 | 🐛 394 | 🌐 Go | 📅 2026-04-03 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,964 | 🐛 51 | 🌐 Go | 📅 2026-04-06 — Vulnerability Static Analysis for Containers.

* [krane](https://github.com/appvia/krane) ⭐ 739 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,433 | 🐛 70 | 🌐 Go | 📅 2026-04-03 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,977 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,627 | 🐛 8 | 🌐 Go | 📅 2026-04-07 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,433 | 🐛 70 | 🌐 Go | 📅 2026-04-03 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,979 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-06 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,026 | 🐛 114 | 🌐 Ruby | 📅 2026-04-02 — A tool to check Markdown files and flag style issues.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,239 | 🐛 242 | 🌐 Java | 📅 2026-03-17 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 869 | 🐛 46 | 🌐 Rust | 📅 2026-04-03 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 736 | 🐛 8 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 90 | 🌐 Python | 📅 2026-04-06 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,814 | 🐛 350 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,559 | 🐛 9 | 🌐 Java | 📅 2026-03-26 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,975 | 🐛 14 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,355 | 🐛 401 | 🌐 Go | 📅 2026-04-06 — Security Scorecards - Security health metrics for Open Source
...
* [haml-lint](https://github.com/sds/haml-lint) ⭐ 335 | 🐛 11 | 🌐 Ruby | 📅 2026-04-07 — Tool for writing clean and consistent HAML.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,519 | 🐛 248 | 🌐 JavaScript | 📅 2026-03-26 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,346 | 🐛 256 | 🌐 Python | 📅 2026-04-06 — Check code for common misspellings.
