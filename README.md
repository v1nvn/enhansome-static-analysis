...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,465 | 🐛 27 | 🌐 Rust | 📅 2026-03-23
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,079 | 🐛 4 | 🌐 Markdown | 📅 2026-02-24.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,128 | 🐛 45 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,808 | 🐛 70 | 🌐 Python | 📅 2026-03-30 — Automated C++ checker that follows Google's style guide.
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,246 | 🐛 36 | 🌐 C# | 📅 2026-04-01 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,104 | 🐛 2 | 🌐 C# | 📅 2026-04-01 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 900 | 🐛 244 | 🌐 C# | 📅 2026-04-02 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,826 | 🐛 105 | 🌐 Clojure | 📅 2026-03-30 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,172 | 🐛 137 | 🌐 Go | 📅 2026-04-02 — A tool for posting review comments from any linter in any code hosting service.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,035 | 🐛 148 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.
...
* [goconst](https://github.com/jgautheron/goconst) ⭐ 314 | 🐛 4 | 🌐 Go | 📅 2026-03-06 — Finds repeated strings that could be replaced by a constant.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,098 | 🐛 165 | 🌐 Java | 📅 2026-04-02 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,026 | 🐛 145 | 🌐 Java | 📅 2026-04-01 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,135 | 🐛 432 | 🌐 Java | 📅 2026-04-02 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,465 | 🐛 27 | 🌐 Rust | 📅 2026-03-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,971 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-27 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,669 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,465 | 🐛 27 | 🌐 Rust | 📅 2026-03-23 — The JavaScript Code Quality Tool.

* [Polymer-analyzer](https://github.com/Polymer/tools/tree/master/packages/analyzer) ⭐ 436 | 🐛 853 | 🌐 TypeScript | 📅 2026-04-02 — A static analysis framework for Web Components.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 855 | 🐛 92 | 🌐 Julia | 📅 2026-03-30 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-04-02 — Static Code Analysis for Julia
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,782 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,485 | 🐛 84 | 🌐 PHP | 📅 2026-04-01.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,348 | 🐛 118 | 🌐 PHP | 📅 2026-03-30 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,275 | 🐛 8 | 🌐 PHP | 📅 2026-03-30 — Checks code on every commit.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,346 | 🐛 244 | 🌐 Python | 📅 2026-03-29 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,416 | 🐛 56 | 🌐 Python | 📅 2026-03-26 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,773 | 🐛 23 | 🌐 Python | 📅 2025-12-22 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,529 | 🐛 32 | 🌐 Python | 📅 2026-02-21 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,075 | 🐛 33 | 🌐 Python | 📅 2026-03-30 — A wrapper around `pylint`, `pep8`, `mccabe` and others.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 372 | 🐛 131 | 🌐 Go | 📅 2026-04-01 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,743 | 🐛 56 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,057 | 🐛 23 | 🌐 Ruby | 📅 2026-03-30.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,480 | 🐛 218 | 🌐 Ruby | 📅 2026-04-01 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,002 | 🐛 471 | 🌐 Rust | 📅 2026-04-01 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,096 | 🐛 100 | 📅 2026-03-31.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 933 | 🐛 25 | 🌐 Rust | 📅 2026-03-30 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,780 | 🐛 913 | 🌐 Rust | 📅 2026-04-01 — A tool for formatting Rust code according to style guidelines.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,763 | 🐛 314 | 🌐 Swift | 📅 2026-03-30 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,174 | 🐛 307 | 🌐 TypeScript | 📅 2026-04-01 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,780 | 🐛 40 | 🌐 TypeScript | 📅 2026-04-01 — Linter for Angular projects
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,286 | 🐛 243 | 🌐 Go | 📅 2026-04-01 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,154 | 🐛 103 | 🌐 JavaScript | 📅 2026-04-01 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,469 | 🐛 597 | 🌐 Rust | 📅 2026-04-01 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,980 | 🐛 593 | 🌐 Vim Script | 📅 2026-04-01 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,413 | 🐛 1,354 | 🌐 CodeQL | 📅 2026-04-01 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,312 | 🐛 52 | 🌐 Python | 📅 2026-03-30 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 978 | 🐛 72 | 🌐 C# | 📅 2026-03-30 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 783 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-01 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 24 | 🐛 2 | 🌐 Rust | 📅 2026-04-01 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,579 | 🐛 605 | 🌐 Python | 📅 2026-04-02 — Binary code analysis tool that also supports symbolic execution.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-04-01 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,971 | 🐛 14 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,610 | 🐛 64 | 🌐 Python | 📅 2026-04-01 — AWS Labs CloudFormation linter.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,033 | 🐛 258 | 🌐 Haskell | 📅 2026-03-09 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,919 | 🐛 390 | 🌐 Go | 📅 2026-04-01 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,956 | 🐛 50 | 🌐 Go | 📅 2026-03-31 — Vulnerability Static Analysis for Containers.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,584 | 🐛 182 | 🌐 Rust | 📅 2026-01-31 — Official linter for Deno.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,429 | 🐛 70 | 🌐 Go | 📅 2026-04-01 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,973 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,429 | 🐛 70 | 🌐 Go | 📅 2026-04-01 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,025 | 🐛 121 | 🌐 Ruby | 📅 2026-04-01 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 102 | 🐛 21 | 🌐 Rust | 📅 2026-04-01 — Format markdown code blocks using your favorite code formatters.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 861 | 🐛 46 | 🌐 Rust | 📅 2026-03-27 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,740 | 🐛 350 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,919 | 🐛 390 | 🌐 Go | 📅 2026-04-01 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,461 | 🐛 143 | 🌐 Python | 📅 2025-03-13 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,348 | 🐛 394 | 🌐 Go | 📅 2026-03-30 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,190 | 🐛 445 | 🌐 Python | 📅 2026-04-02 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,516 | 🐛 248 | 🌐 JavaScript | 📅 2026-03-26 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,342 | 🐛 254 | 🌐 Python | 📅 2026-03-31 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,750 | 🐛 573 | 🌐 Go | 📅 2026-03-26 — A collection of tools and libraries for working with Go code, including linters and static analysis
