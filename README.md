...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,474 | 🐛 26 | 🌐 Rust | 📅 2026-03-23
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,079 | 🐛 3 | 🌐 Markdown | 📅 2026-02-24.
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,807 | 🐛 70 | 🌐 Python | 📅 2026-03-30 — Automated C++ checker that follows Google's style guide.
...
* [sobelow](https://github.com/nccgroup/sobelow) ⭐ 1,776 | 🐛 37 | 🌐 Elixir | 📅 2024-08-20 — Security-focused static analysis for the Phoenix Framework.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,183 | 🐛 138 | 🌐 Go | 📅 2026-04-05 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,905 | 🐛 29 | 🌐 Go | 📅 2026-02-18 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,101 | 🐛 164 | 🌐 Java | 📅 2026-04-04 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,029 | 🐛 143 | 🌐 Java | 📅 2026-04-03 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 438 | 🌐 Java | 📅 2026-04-05 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,474 | 🐛 26 | 🌐 Rust | 📅 2026-03-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,669 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,474 | 🐛 26 | 🌐 Rust | 📅 2026-03-23 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 856 | 🐛 94 | 🌐 Julia | 📅 2026-04-06 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-04-06 — Static Code Analysis for Julia
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 608 | 🐛 18 | 🌐 PHP | 📅 2026-01-28 — Fast detection of composer dependency issues.
...
* [larastan](https://github.com/larastan/larastan) ⭐ 6,355 | 🐛 119 | 🌐 PHP | 📅 2026-04-03 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,279 | 🐛 8 | 🌐 PHP | 📅 2026-03-30 — Checks code on every commit.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 886 | 🐛 33 | 🌐 PHP | 📅 2026-04-05 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,355 | 🐛 246 | 🌐 Python | 📅 2026-03-29 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,421 | 🐛 56 | 🌐 Python | 📅 2026-03-26 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,769 | 🐛 23 | 🌐 Python | 📅 2026-04-05 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,528 | 🐛 30 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,076 | 🐛 33 | 🌐 Python | 📅 2026-03-30 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,958 | 🐛 50 | 🌐 Python | 📅 2024-10-20.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,271 | 🐛 315 | 🌐 R | 📅 2026-03-31 — Static Code Analysis for R.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,744 | 🐛 58 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,057 | 🐛 25 | 🌐 Ruby | 📅 2026-03-30.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,480 | 🐛 220 | 🌐 Ruby | 📅 2026-04-06 — Gradual Typing for Ruby.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,059 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,010 | 🐛 473 | 🌐 Rust | 📅 2026-04-06 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,096 | 🐛 100 | 📅 2026-04-06.
...
* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 652 | 🐛 40 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,785 | 🐛 916 | 🌐 Rust | 📅 2026-04-01 — A tool for formatting Rust code according to style guidelines.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,769 | 🐛 313 | 🌐 Swift | 📅 2026-03-30 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,187 | 🐛 308 | 🌐 TypeScript | 📅 2026-04-05 — TypeScript language extension for eslint.
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 363 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-03 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,366 | 🐛 248 | 🌐 Go | 📅 2026-04-03 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,141 | 🐛 103 | 🌐 JavaScript | 📅 2026-04-06 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,552 | 🐛 618 | 🌐 Rust | 📅 2026-04-06 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,979 | 🐛 596 | 🌐 Vim Script | 📅 2026-04-01 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,430 | 🐛 1,375 | 🌐 CodeQL | 📅 2026-04-03 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,977 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,662 | 🐛 14 | 🌐 Ruby | 📅 2026-04-06 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,611 | 🐛 25 | 🌐 Go | 📅 2026-04-06 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,324 | 🐛 52 | 🌐 Python | 📅 2026-03-30 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 980 | 🐛 72 | 🌐 C# | 📅 2026-03-30 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [angr](https://github.com/angr/angr) ⭐ 8,586 | 🐛 604 | 🌐 Python | 📅 2026-04-05 — Binary code analysis tool that also supports symbolic execution.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,044 | 🐛 258 | 🌐 Haskell | 📅 2026-03-09 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,957 | 🐛 394 | 🌐 Go | 📅 2026-04-03 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,963 | 🐛 49 | 🌐 Go | 📅 2026-04-03 — Vulnerability Static Analysis for Containers.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,432 | 🐛 70 | 🌐 Go | 📅 2026-04-03 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,627 | 🐛 9 | 🌐 Go | 📅 2026-04-05 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,432 | 🐛 70 | 🌐 Go | 📅 2026-04-03 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,973 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-06 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 865 | 🐛 46 | 🌐 Rust | 📅 2026-04-03 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 740 | 🐛 8 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,792 | 🐛 350 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,957 | 🐛 394 | 🌐 Go | 📅 2026-04-03 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,470 | 🐛 143 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,354 | 🐛 403 | 🌐 Go | 📅 2026-04-03 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,196 | 🐛 449 | 🌐 Python | 📅 2026-04-05 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,345 | 🐛 256 | 🌐 Python | 📅 2026-04-04 — Check code for common misspellings.
