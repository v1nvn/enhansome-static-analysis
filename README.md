...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,384 | 🐛 4 | 🌐 Rust | 📅 2026-02-11
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,114 | 🐛 44 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,186 | 🐛 36 | 🌐 C# | 📅 2026-02-18 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,090 | 🐛 3 | 🌐 C# | 📅 2026-02-16 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 893 | 🐛 238 | 🌐 C# | 📅 2026-02-18 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,141 | 🐛 32 | 🌐 Elixir | 📅 2026-02-16 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,079 | 🐛 141 | 🌐 Go | 📅 2026-02-17 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,856 | 🐛 29 | 🌐 Go | 📅 2025-12-20 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [prealloc](https://github.com/alexkohler/prealloc) ⭐ 663 | 🐛 4 | 🌐 Go | 📅 2026-02-17 — Finds slice declarations that could potentially be preallocated.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,072 | 🐛 167 | 🌐 Java | 📅 2026-02-18 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,005 | 🐛 134 | 🌐 Java | 📅 2026-02-18 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,130 | 🐛 430 | 🌐 Java | 📅 2026-02-17 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,384 | 🐛 4 | 🌐 Rust | 📅 2026-02-11 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,657 | 🐛 7 | 🌐 JavaScript | 📅 2026-01-01 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,384 | 🐛 4 | 🌐 Rust | 📅 2026-02-11 — The JavaScript Code Quality Tool.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,798 | 🐛 269 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,464 | 🐛 91 | 🌐 PHP | 📅 2026-02-16.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,307 | 🐛 109 | 🌐 PHP | 📅 2026-02-13 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,601 | 🐛 801 | 🌐 PHP | 📅 2026-02-09 — A modern static analyzer from etsy.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,297 | 🐛 4 | 🌐 Dockerfile | 📅 2026-02-17 — Many tools for PHP static analysis in one container.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 866 | 🐛 39 | 🌐 PHP | 📅 2026-02-17 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,231 | 🐛 207 | 🌐 Python | 📅 2026-02-17 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,327 | 🐛 55 | 🌐 Python | 📅 2025-11-25 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,757 | 🐛 23 | 🌐 Python | 📅 2025-12-22 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,524 | 🐛 38 | 🌐 Python | 📅 2026-02-17 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 361 | 🐛 141 | 🌐 Go | 📅 2026-02-17 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,737 | 🐛 51 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,053 | 🐛 17 | 🌐 Ruby | 📅 2026-02-15.
...
* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,163 | 🐛 7 | 🌐 Ruby | 📅 2026-02-17 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [kani](https://github.com/model-checking/kani) ⭐ 2,940 | 🐛 489 | 🌐 Rust | 📅 2026-02-17 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,081 | 🐛 40 | 🌐 Rust | 📅 2025-12-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,081 | 🐛 100 | 📅 2026-02-18.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,742 | 🐛 913 | 🌐 Rust | 📅 2026-02-12 — A tool for formatting Rust code according to style guidelines.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 554 | 🐛 50 | 🌐 Scala | 📅 2026-02-17 — Scala compiler plugin for static code analysis.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,100 | 🐛 304 | 🌐 TypeScript | 📅 2026-02-17 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,774 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-17 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 352 | 🐛 77 | 🌐 TypeScript | 📅 2026-02-17 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 69 | 🐛 4 | 🌐 Rust | 📅 2026-02-18 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 31,951 | 🐛 222 | 🌐 Go | 📅 2026-02-17 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 26,906 | 🐛 93 | 🌐 JavaScript | 📅 2026-02-18 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 19,031 | 🐛 429 | 🌐 Rust | 📅 2026-02-18 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,964 | 🐛 586 | 🌐 Vim Script | 📅 2026-02-17 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,242 | 🐛 1,293 | 🌐 CodeQL | 📅 2026-02-17 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,383 | 🐛 22 | 🌐 C# | 📅 2026-02-17 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,562 | 🐛 28 | 🌐 Go | 📅 2026-02-16 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,669 | 🐛 1,053 | 📅 2026-02-16 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 971 | 🐛 64 | 🌐 C# | 📅 2026-02-17 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-17 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-02-17 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,501 | 🐛 590 | 🌐 Python | 📅 2026-02-18 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,368 | 🐛 60 | 🌐 C++ | 📅 2026-02-14 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 568 | 🐛 2 | 🌐 C++ | 📅 2026-02-17 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,607 | 🐛 103 | 🌐 Python | 📅 2026-02-17 — AWS Labs CloudFormation linter.
...
* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,304 | 🐛 83 | 🌐 Ruby | 📅 2024-08-01 — A linter for AWS CloudFormation templates.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 11,953 | 🐛 249 | 🌐 Haskell | 📅 2026-01-27 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,574 | 🐛 355 | 🌐 Go | 📅 2026-02-17 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,581 | 🐛 174 | 🌐 Rust | 📅 2026-01-31 — Official linter for Deno.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,396 | 🐛 78 | 🌐 Go | 📅 2026-02-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,933 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,396 | 🐛 78 | 🌐 Go | 📅 2026-02-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,847 | 🐛 81 | 🌐 JavaScript | 📅 2026-02-17 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 824 | 🐛 46 | 🌐 Rust | 📅 2026-02-13 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 718 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 161 | 🐛 87 | 🌐 Python | 📅 2026-02-17 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 24,952 | 🐛 343 | 🌐 Go | 📅 2026-01-08 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,267 | 🐛 382 | 🌐 Go | 📅 2026-02-16 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,136 | 🐛 429 | 🌐 Python | 📅 2026-02-16 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [haml-lint](https://github.com/sds/haml-lint) ⭐ 334 | 🐛 11 | 🌐 Ruby | 📅 2026-02-17 — Tool for writing clean and consistent HAML.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,721 | 🐛 586 | 🌐 Go | 📅 2026-02-13 — A collection of tools and libraries for working with Go code, including linters and static analysis
