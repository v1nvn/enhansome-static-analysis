...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,525 | 🐛 39 | 🌐 Rust | 📅 2026-04-23
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,079 | 🐛 2 | 🌐 Markdown | 📅 2026-05-03.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,143 | 🐛 46 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,815 | 🐛 72 | 🌐 Python | 📅 2026-04-19 — Automated C++ checker that follows Google's style guide.

* [clazy](https://github.com/KDE/clazy) ⭐ 732 | 🐛 0 | 🌐 C++ | 📅 2026-04-25 — Qt-oriented static code analyzer based on the Clang framework. clazy is a compiler plugin which allows clang to understand Qt semantics. You get more than 50 Qt related compiler warnings, ranging from unneeded memory allocations to misusage of API, including fix-its for automatic refactoring.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,417 | 🐛 225 | 🌐 C# | 📅 2026-03-25 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,279 | 🐛 36 | 🌐 C# | 📅 2026-05-03 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,126 | 🐛 3 | 🌐 C# | 📅 2026-05-03 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 904 | 🐛 240 | 🌐 C# | 📅 2026-05-02 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.

* [Wintellect.Analyzers](https://github.com/Wintellect/Wintellect.Analyzers) ⭐ 88 | 🐛 2 | 🌐 C# | 📅 2016-11-25 — .NET Compiler Platform ("Roslyn") diagnostic analyzers and code fixes.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,833 | 🐛 110 | 🌐 Clojure | 📅 2026-05-03 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [DelphiLint](https://github.com/integrated-application-development/delphilint) ⭐ 136 | 🐛 11 | 🌐 Pascal | 📅 2026-01-27 — A Delphi IDE package providing on-the-fly code analysis and linting, powered by SonarDelphi.
...
* [D-scanner](https://github.com/dlang-community/D-Scanner) ⭐ 254 | 🐛 128 | 🌐 D | 📅 2026-02-18 — D-Scanner is a tool for analyzing D source code.

<a name="elixir" />
<h2>Elixir</h2>

* [credo](https://github.com/rrrene/credo) ⭐ 5,174 | 🐛 27 | 🌐 Elixir | 📅 2026-05-04 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,788 | 🐛 79 | 🌐 Elixir | 📅 2025-11-06 — Mix tasks to simplify use of Dialyzer in Elixir projects.
...
* [elvis](https://github.com/inaka/elvis) ⭐ 430 | 🐛 1 | 🌐 Erlang | 📅 2026-04-24 — Erlang Style Reviewer.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 322 | 🐛 96 | 🌐 F# | 📅 2026-02-12 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,263 | 🐛 143 | 🌐 Go | 📅 2026-05-01 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,924 | 🐛 15 | 🌐 Go | 📅 2026-05-03 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,481 | 🐛 17 | 🌐 Go | 📅 2026-04-26 — Check that error return values are used.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,046 | 🐛 149 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.

* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,566 | 🐛 11 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.

* [misspell](https://github.com/client9/misspell) ⚠️ Archived — Finds commonly misspelled English words.

* [structslop](https://github.com/orijtech/structslop) ⭐ 835 | 🐛 11 | 🌐 Go | 📅 2024-02-08 — Static analyzer for Go that recommends struct field rearrangements to provide for maximum space/allocation efficiency
...
* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 463 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.

* [dupl](https://github.com/mibk/dupl) ⭐ 368 | 🐛 4 | 🌐 Go | 📅 2026-03-05 — Reports potentially duplicated code.

* [wsl](https://github.com/bombsimon/wsl) ⭐ 349 | 🐛 3 | 🌐 Go | 📅 2026-05-02 — Enforces empty lines at the right places.

* [bodyclose](https://github.com/timakin/bodyclose) ⭐ 324 | 🐛 30 | 🌐 Go | 📅 2026-01-29 — Checks whether HTTP response body is closed.

* [goconst](https://github.com/jgautheron/goconst) ⭐ 316 | 🐛 0 | 🌐 Go | 📅 2026-04-03 — Finds repeated strings that could be replaced by a constant.
...
* [goast](https://github.com/m-mizutani/goast) ⭐ 65 | 🐛 1 | 🌐 Go | 📅 2026-03-20 — Go AST (Abstract Syntax Tree) based static analysis tool with Rego.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,594 | 🐛 306 | 🌐 Haskell | 📅 2026-03-22 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,121 | 🐛 167 | 🌐 Java | 📅 2026-04-30 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,042 | 🐛 149 | 🌐 Java | 📅 2026-05-04 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 430 | 🌐 Java | 📅 2026-05-03 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [ck](https://github.com/mauricioaniche/ck) ⭐ 451 | 🐛 31 | 🌐 Java | 📅 2026-04-29 — Calculates Chidamber and Kemerer object-oriented metrics by processing the source Java files.
...
* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 157 | 🐛 10 | 🌐 Java | 📅 2026-03-28 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.

* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 28 | 🐛 18 | 🌐 Java | 📅 2026-04-30 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 80 | 🐛 31 | 🌐 Java | 📅 2026-04-26 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,525 | 🐛 39 | 🌐 Rust | 📅 2026-04-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,969 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,664 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,525 | 🐛 39 | 🌐 Rust | 📅 2026-04-23 — The JavaScript Code Quality Tool.

* [Polymer-analyzer](https://github.com/Polymer/tools/tree/master/packages/analyzer) ⭐ 436 | 🐛 867 | 🌐 TypeScript | 📅 2026-05-04 — A static analysis framework for Web Components.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 860 | 🐛 93 | 🌐 Julia | 📅 2026-05-04 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-05-04 — Static Code Analysis for Julia
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 443 | 🐛 41 | 🌐 Lua | 📅 2026-04-20 — A tool for linting and static analysis of Lua code.
...
* [VeriFast](https://github.com/verifast/verifast) ⭐ 481 | 🐛 120 | 🌐 Rust | 📅 2026-03-19 — A tool for modular formal verification of correctness properties of single-threaded and multithreaded  C and Java programs annotated with preconditions and postconditions written in separation logic.  To express rich specifications, the programmer can define inductive datatypes,  primitive recursive pure functions over these datatypes, and abstract separation logic predicates.
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 615 | 🐛 20 | 🌐 PHP | 📅 2026-04-24 — Fast detection of composer dependency issues.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,432 | 🐛 66 | 🌐 PHP | 📅 2026-02-26 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,771 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,508 | 🐛 83 | 🌐 PHP | 📅 2026-05-03.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,377 | 🐛 126 | 🌐 PHP | 📅 2026-04-22 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,615 | 🐛 795 | 🌐 PHP | 📅 2026-04-19 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,596 | 🐛 71 | 🌐 PHP | 📅 2026-04-18 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,288 | 🐛 10 | 🌐 PHP | 📅 2026-04-16 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,933 | 🐛 30 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.

* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,314 | 🐛 3 | 🌐 Dockerfile | 📅 2026-04-20 — Many tools for PHP static analysis in one container.

* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,258 | 🐛 11 | 🌐 PHP | 📅 2026-03-17 — Easy to use architecture testing tool for PHP.

* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 903 | 🐛 32 | 🌐 PHP | 📅 2026-04-27 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.

* [phpmnd](https://github.com/povils/phpmnd) ⭐ 582 | 🐛 21 | 🌐 PHP | 📅 2026-02-25 — Helps to detect magic numbers.
...
* [Parse](https://github.com/psecio/parse) ⭐ 382 | 🐛 18 | 🌐 PHP | 📅 2018-08-07 — A Static Security Scanner.

* [Progpilot](https://github.com/designsecurity/progpilot) ⭐ 362 | 🐛 4 | 🌐 PHP | 📅 2025-08-17 — A static analysis tool for security purposes.

* [parallel-lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) ⭐ 353 | 🐛 29 | 🌐 PHP | 📅 2026-04-20 — This tool checks syntax of PHP files faster than serial check with a fancier output.
...
* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 125 | 🐛 12 | 🌐 PHP | 📅 2026-04-24 — Reflection library to do Static Analysis for PHP Projects
...
* [zarn](https://github.com/htrgouvea/zarn) ⭐ 58 | 🐛 4 | 🌐 Perl | 📅 2026-04-07 — A lightweight static security analysis tool for modern Perl Apps

<a name="python" />
<h2>Python</h2>

* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,406 | 🐛 270 | 🌐 Python | 📅 2026-04-22 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,997 | 🐛 75 | 🌐 Python | 📅 2026-02-11.

* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,572 | 🐛 56 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,781 | 🐛 23 | 🌐 Python | 📅 2026-04-28 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,527 | 🐛 30 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,075 | 🐛 33 | 🌐 Python | 📅 2026-04-27 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,976 | 🐛 50 | 🌐 Python | 📅 2024-10-20.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,282 | 🐛 34 | 🌐 Python | 📅 2026-04-26 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,274 | 🐛 64 | 🌐 Python | 📅 2026-04-23 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.

* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 956 | 🐛 43 | 🌐 Python | 📅 2026-04-20 — Autoflake removes unused imports and unused variables from Python code.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 379 | 🐛 133 | 🌐 Go | 📅 2026-05-01 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,893 | 🐛 44 | 🌐 Ruby | 📅 2026-05-02 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,748 | 🐛 60 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,060 | 🐛 33 | 🌐 Ruby | 📅 2026-03-30.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,914 | 🐛 30 | 🌐 Ruby | 📅 2026-01-12 — Identify database issues before they hit production.

* [Fasterer](https://github.com/DamirSvrtan/fasterer) ⭐ 1,822 | 🐛 12 | 🌐 Ruby | 📅 2024-06-14 — Common Ruby idioms checker.

* [Steep](https://github.com/soutaro/steep) ⭐ 1,482 | 🐛 209 | 🌐 Ruby | 📅 2026-04-28 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,183 | 🐛 6 | 🌐 Ruby | 📅 2026-04-24 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [ERB Lint](https://github.com/Shopify/erb-lint) ⭐ 744 | 🐛 93 | 🌐 Ruby | 📅 2026-04-20 — Lint your ERB or HTML files

* [Rubrowser](https://github.com/blazeeboy/rubrowser) ⭐ 646 | 🐛 2 | 🌐 JavaScript | 📅 2023-08-19 — Ruby classes interactive dependency graph generator.
...
* [htmlbeautifier](https://github.com/threedaymonk/htmlbeautifier) ⭐ 373 | 🐛 18 | 🌐 Ruby | 📅 2024-02-13 — A normaliser/beautifier for HTML that also understands embedded Ruby. Ideal for tidying up Rails templates.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,073 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,060 | 🐛 472 | 🌐 Rust | 📅 2026-05-04 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,095 | 🐛 41 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,107 | 🐛 110 | 📅 2026-05-02.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 940 | 🐛 27 | 🌐 Rust | 📅 2026-05-03 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code

* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 658 | 🐛 40 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.

* [cargo-spellcheck](https://github.com/drahnr/cargo-spellcheck) ⭐ 361 | 🐛 58 | 🌐 Rust | 📅 2026-05-01 — Checks all your documentation for spelling and grammar mistakes  with hunspell (ready) and languagetool (preview)
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,819 | 🐛 919 | 🌐 Rust | 📅 2026-04-29 — A tool for formatting Rust code according to style guidelines.

* [RustViz](https://github.com/rustviz/rustviz) ⭐ 2,826 | 🐛 24 | 🌐 HTML | 📅 2024-02-13 — RustViz is a tool that generates visualizations  from simple Rust programs to assist users in better  understanding the Rust Lifetime and Borrowing mechanism. It generates SVG files with graphical indicators that integrate  with mdbook to render visualizations of data-flow in Rust programs.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 823 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [lockbud](https://github.com/BurtonQin/lockbud) ⭐ 589 | 🐛 27 | 🌐 Rust | 📅 2026-04-21 — Statically detects Rust deadlocks bugs. It currently detects two common kinds of deadlock bugs: doublelock and locks in conflicting order. It will print bugs in JSON format together with the source code location and an explanation of each bug.
...
* [sleek](https://github.com/nrempel/sleek) ⭐ 279 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-18 — Sleek is a CLI tool for formatting SQL.  It helps you maintain a consistent style across your SQL code, enhancing readability and productivity. The heavy lifting is done by the sqlformat crate.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 133 | 🐛 5 | 🌐 Python | 📅 2026-05-01 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 555 | 🐛 50 | 🌐 Scala | 📅 2026-04-30 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,781 | 🐛 8 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.

* [bashate](https://github.com/openstack/bashate) ⭐ 393 | 🐛 0 | 🌐 Python | 📅 2024-11-26 — Code style enforcement for bash programs. The output format aims to follow pycodestyle (pep8) default output format.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,789 | 🐛 287 | 🌐 Swift | 📅 2026-04-27 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,228 | 🐛 305 | 🌐 TypeScript | 📅 2026-05-01 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,782 | 🐛 45 | 🌐 TypeScript | 📅 2026-04-30 — Linter for Angular projects

* [TypeScript Call Graph](https://github.com/whyboris/TypeScript-Call-Graph) ⭐ 285 | 🐛 10 | 🌐 JavaScript | 📅 2025-10-26 — CLI to generate an interactive graph of functions and calls from your TypeScript files
...
* [svls](https://github.com/dalance/svls) ⭐ 574 | 🐛 26 | 🌐 Rust | 📅 2026-04-02 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 368 | 🐛 79 | 🌐 TypeScript | 📅 2026-05-04 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 75 | 🐛 1 | 🌐 Rust | 📅 2026-05-04 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,827 | 🐛 259 | 🌐 Go | 📅 2026-05-01 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,217 | 🐛 114 | 🌐 JavaScript | 📅 2026-05-04 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,962 | 🐛 636 | 🌐 Rust | 📅 2026-05-04 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,987 | 🐛 597 | 🌐 Vim Script | 📅 2026-04-15 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,549 | 🐛 1,369 | 🌐 CodeQL | 📅 2026-05-01 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,261 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.

* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,391 | 🐛 25 | 🌐 C# | 📅 2026-02-17 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,978 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,666 | 🐛 14 | 🌐 Ruby | 📅 2026-05-04 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,641 | 🐛 21 | 🌐 Go | 📅 2026-05-04 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,351 | 🐛 54 | 🌐 Python | 📅 2026-04-24 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,945 | 🐛 196 | 📅 2026-04-27 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,673 | 🐛 1,058 | 📅 2026-05-01 — Roslyn-based implementation of FxCop analyzers.
...
* [WALA](https://github.com/wala/WALA) ⭐ 843 | 🐛 150 | 🌐 Java | 📅 2026-04-29 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 786 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-01 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [todocheck](https://github.com/preslavmihaylov/todocheck) ⭐ 436 | 🐛 15 | 🌐 Go | 📅 2025-08-02 — Linter for integrating annotated TODOs with your issue trackers

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 429 | 🐛 3 | 🌐 Python | 📅 2026-05-04 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.

* [callGraph](https://github.com/koknat/callGraph) ⭐ 333 | 🐛 6 | 🌐 Perl | 📅 2024-11-20 — Statically generates a call graph image and displays it on screen.

* [Depends](https://github.com/multilang-depends/depends) ⭐ 250 | 🐛 12 | 🌐 Java | 📅 2026-04-20 — Analyses the comprehensive dependencies of code elements for Java, C/C++, Ruby.

* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 225 | 🐛 3 | 🌐 Go | 📅 2026-05-03 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 111 | 🐛 8 | 🌐 Rust | 📅 2026-05-03 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 24 | 🐛 1 | 🌐 Rust | 📅 2026-05-01 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,630 | 🐛 608 | 🌐 Python | 📅 2026-05-04 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,436 | 🐛 61 | 🌐 C++ | 📅 2026-04-24 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,122 | 🐛 6 | 🌐 YARA | 📅 2026-03-11 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 852 | 🐛 159 | 🌐 C# | 📅 2026-05-01 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 823 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 577 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 571 | 🐛 2 | 🌐 C++ | 📅 2026-05-03 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,193 | 🐛 34 | 🌐 Go | 📅 2026-04-23 — Linter / Analyzer for Makefiles.
...
* [gixy](https://github.com/yandex/gixy) ⭐ 8,557 | 🐛 56 | 🌐 Python | 📅 2024-07-28 — A tool to analyze Nginx configuration. The main goal is to prevent misconfiguration and automate flaw detection.

<a name="configmanagement" />
<h2>Configuration Management</h2>

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,992 | 🐛 15 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,611 | 🐛 69 | 🌐 Python | 📅 2026-05-03 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,380 | 🐛 50 | 🌐 Rust | 📅 2026-04-28 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.

* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,308 | 🐛 84 | 🌐 Ruby | 📅 2024-08-01 — A linter for AWS CloudFormation templates.

* [metadata-json-lint](https://github.com/voxpupuli/metadata-json-lint) ⭐ 31 | 🐛 13 | 🌐 Ruby | 📅 2026-04-30 — Tool to check the validity of Puppet metadata.json files.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,134 | 🐛 400 | 🌐 Go | 📅 2026-05-01 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,104 | 🐛 240 | 🌐 Haskell | 📅 2026-04-30 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 10,974 | 🐛 47 | 🌐 Go | 📅 2026-04-27 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,250 | 🐛 41 | 🌐 Go | 📅 2026-04-04 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.

* [krane](https://github.com/appvia/krane) ⭐ 740 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,582 | 🐛 184 | 🌐 Rust | 📅 2026-05-02 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 81 | 🐛 5 | 🌐 Python | 📅 2026-04-30 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,445 | 🐛 73 | 🌐 Go | 📅 2026-04-29 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,013 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,627 | 🐛 5 | 🌐 Go | 📅 2026-04-28 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.

* [krane](https://github.com/appvia/krane) ⭐ 740 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
  It identifies potential security risks in K8s RBAC design and makes suggestions on how to mitigate them. Krane dashboard presents current RBAC security posture and lets you navigate through its definition.

* [clusterlint](https://github.com/digitalocean/clusterlint) ⭐ 589 | 🐛 11 | 🌐 Go | 📅 2026-04-29 — Clusterlint queries live Kubernetes clusters for resources, executes common and  platform specific checks against these resources and provides actionable feedback to cluster operators.  It is a non invasive tool that is run externally. Clusterlint does not alter the resource configurations.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,445 | 🐛 73 | 🌐 Go | 📅 2026-04-29 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,046 | 🐛 82 | 🌐 JavaScript | 📅 2026-05-04 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,038 | 🐛 120 | 🌐 Ruby | 📅 2026-04-19 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 106 | 🐛 24 | 🌐 Rust | 📅 2026-05-04 — Format markdown code blocks using your favorite code formatters.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,241 | 🐛 242 | 🌐 Java | 📅 2026-04-08 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 894 | 🐛 46 | 🌐 Rust | 📅 2026-05-01 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 748 | 🐛 8 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)

<a name="nodejs" />
<h2>Node.js</h2>

* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 851 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-25 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 87 | 🌐 Python | 📅 2026-04-29 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 688 | 🐛 57 | 🌐 Go | 📅 2026-04-30 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 26,524 | 🐛 363 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,134 | 🐛 400 | 🌐 Go | 📅 2026-05-01 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,497 | 🐛 144 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,565 | 🐛 11 | 🌐 Java | 📅 2026-04-16 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,992 | 🐛 15 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,418 | 🐛 391 | 🌐 Go | 📅 2026-04-29 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,234 | 🐛 459 | 🌐 Python | 📅 2026-04-29 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,235 | 🐛 127 | 🌐 Python | 📅 2026-04-27 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 51 | 🐛 27 | 🌐 Python | 📅 2026-05-01 — A set of utilities for working with PO files to ease development and improve quality.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,526 | 🐛 252 | 🌐 JavaScript | 📅 2026-04-21 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,363 | 🐛 254 | 🌐 Python | 📅 2026-04-29 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,772 | 🐛 571 | 🌐 Go | 📅 2026-04-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
