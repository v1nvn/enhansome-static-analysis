...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,541 | 🐛 42 | 🌐 Rust | 📅 2026-05-07
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,086 | 🐛 2 | 🌐 Markdown | 📅 2026-05-03.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,147 | 🐛 46 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,419 | 🐛 226 | 🌐 C# | 📅 2026-03-25 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,284 | 🐛 36 | 🌐 C# | 📅 2026-05-10 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,129 | 🐛 2 | 🌐 C# | 📅 2026-05-12 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,839 | 🐛 115 | 🌐 Clojure | 📅 2026-05-11 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,179 | 🐛 26 | 🌐 Elixir | 📅 2026-05-12 — A static code analysis tool with a focus on code consistency and teaching.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 323 | 🐛 96 | 🌐 F# | 📅 2026-02-12 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,286 | 🐛 145 | 🌐 Go | 📅 2026-05-12 — A tool for posting review comments from any linter in any code hosting service.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,492 | 🐛 16 | 🌐 Go | 📅 2026-05-11 — Check that error return values are used.
...
* [goconst](https://github.com/jgautheron/goconst) ⭐ 317 | 🐛 1 | 🌐 Go | 📅 2026-05-08 — Finds repeated strings that could be replaced by a constant.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,131 | 🐛 167 | 🌐 Java | 📅 2026-04-30 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,044 | 🐛 153 | 🌐 Java | 📅 2026-05-10 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 437 | 🌐 Java | 📅 2026-05-11 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 524 | 🐛 59 | 🌐 Java | 📅 2026-05-11 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,541 | 🐛 42 | 🌐 Rust | 📅 2026-05-07 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,971 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-02 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,663 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,541 | 🐛 42 | 🌐 Rust | 📅 2026-05-07 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 861 | 🐛 93 | 🌐 Julia | 📅 2026-05-11 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-05-12 — Static Code Analysis for Julia
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 444 | 🐛 41 | 🌐 Lua | 📅 2026-04-20 — A tool for linting and static analysis of Lua code.
...
* [VeriFast](https://github.com/verifast/verifast) ⭐ 480 | 🐛 120 | 🌐 Rust | 📅 2026-05-10 — A tool for modular formal verification of correctness properties of single-threaded and multithreaded  C and Java programs annotated with preconditions and postconditions written in separation logic.  To express rich specifications, the programmer can define inductive datatypes,  primitive recursive pure functions over these datatypes, and abstract separation logic predicates.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,772 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,508 | 🐛 83 | 🌐 PHP | 📅 2026-05-11.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,393 | 🐛 130 | 🌐 PHP | 📅 2026-04-22 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,616 | 🐛 795 | 🌐 PHP | 📅 2026-05-05 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,599 | 🐛 71 | 🌐 PHP | 📅 2026-04-18 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,290 | 🐛 11 | 🌐 PHP | 📅 2026-05-12 — Checks code on every commit.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,315 | 🐛 3 | 🌐 Dockerfile | 📅 2026-05-11 — Many tools for PHP static analysis in one container.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,423 | 🐛 260 | 🌐 Python | 📅 2026-05-11 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,595 | 🐛 56 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,786 | 🐛 24 | 🌐 Python | 📅 2026-05-11 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,531 | 🐛 30 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,076 | 🐛 33 | 🌐 Python | 📅 2026-04-27 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,985 | 🐛 50 | 🌐 Python | 📅 2024-10-20.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,288 | 🐛 35 | 🌐 Python | 📅 2026-05-11 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 380 | 🐛 139 | 🌐 Go | 📅 2026-05-11 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,749 | 🐛 60 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,060 | 🐛 31 | 🌐 Ruby | 📅 2026-05-12.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,483 | 🐛 212 | 🌐 Ruby | 📅 2026-05-12 — Gradual Typing for Ruby.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,076 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,069 | 🐛 470 | 🌐 Rust | 📅 2026-05-11 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,100 | 🐛 41 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.

* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,574 | 🐛 55 | 🌐 Rust | 📅 2026-01-11 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,112 | 🐛 111 | 📅 2026-05-12.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,827 | 🐛 928 | 🌐 Rust | 📅 2026-05-12 — A tool for formatting Rust code according to style guidelines.

* [RustViz](https://github.com/rustviz/rustviz) ⭐ 2,826 | 🐛 39 | 🌐 Rust | 📅 2026-05-10 — RustViz is a tool that generates visualizations  from simple Rust programs to assist users in better  understanding the Rust Lifetime and Borrowing mechanism. It generates SVG files with graphical indicators that integrate  with mdbook to render visualizations of data-flow in Rust programs.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 822 | 🐛 16 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 133 | 🐛 5 | 🌐 Python | 📅 2026-05-10 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 555 | 🐛 52 | 🌐 Scala | 📅 2026-05-09 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,782 | 🐛 9 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,797 | 🐛 288 | 🌐 Swift | 📅 2026-05-07 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,242 | 🐛 312 | 🌐 TypeScript | 📅 2026-05-11 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,783 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-12 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 368 | 🐛 80 | 🌐 TypeScript | 📅 2026-05-12 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 74 | 🐛 1 | 🌐 Rust | 📅 2026-05-10 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,943 | 🐛 258 | 🌐 Go | 📅 2026-05-11 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,244 | 🐛 108 | 🌐 JavaScript | 📅 2026-05-12 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 21,080 | 🐛 616 | 🌐 Rust | 📅 2026-05-12 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 9,576 | 🐛 1,388 | 🌐 CodeQL | 📅 2026-05-12 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,266 | 🐛 143 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,983 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,649 | 🐛 19 | 🌐 Go | 📅 2026-05-11 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [WALA](https://github.com/wala/WALA) ⭐ 846 | 🐛 151 | 🌐 Java | 📅 2026-05-08 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-11 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 228 | 🐛 4 | 🌐 Go | 📅 2026-05-04 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,650 | 🐛 613 | 🌐 Python | 📅 2026-05-12 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,444 | 🐛 63 | 🌐 C++ | 📅 2026-04-24 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,125 | 🐛 6 | 🌐 YARA | 📅 2026-03-11 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 852 | 🐛 160 | 🌐 C# | 📅 2026-05-11 — A binary static analysis tool that provides security and correctness results for Windows portable executables.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 574 | 🐛 2 | 🌐 C++ | 📅 2026-05-10 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,195 | 🐛 35 | 🌐 Go | 📅 2026-05-11 — Linter / Analyzer for Makefiles.
...
* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,996 | 🐛 16 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,612 | 🐛 70 | 🌐 Python | 📅 2026-05-11 — AWS Labs CloudFormation linter.
...
* [tflint](https://github.com/wata727/tflint) ⭐ 0 | 🐛 0 | 📅 2026-05-10 — A Terraform linter for detecting errors that can not be detected by `terraform plan`.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,186 | 🐛 364 | 🌐 Go | 📅 2026-05-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,131 | 🐛 244 | 🌐 Haskell | 📅 2026-05-04 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 10,977 | 🐛 46 | 🌐 Go | 📅 2026-05-11 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,254 | 🐛 41 | 🌐 Go | 📅 2026-04-04 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,582 | 🐛 185 | 🌐 Rust | 📅 2026-05-02 — Official linter for Deno.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,445 | 🐛 75 | 🌐 Go | 📅 2026-05-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,019 | 🐛 86 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,628 | 🐛 5 | 🌐 Go | 📅 2026-05-12 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,445 | 🐛 75 | 🌐 Go | 📅 2026-05-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,057 | 🐛 82 | 🌐 JavaScript | 📅 2026-05-11 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,043 | 🐛 120 | 🌐 Ruby | 📅 2026-04-19 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 108 | 🐛 16 | 🌐 Rust | 📅 2026-05-11 — Format markdown code blocks using your favorite code formatters.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 900 | 🐛 47 | 🌐 Rust | 📅 2026-05-08 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 88 | 🌐 Python | 📅 2026-05-12 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 26,854 | 🐛 372 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,186 | 🐛 364 | 🌐 Go | 📅 2026-05-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,507 | 🐛 144 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,569 | 🐛 12 | 🌐 Java | 📅 2026-05-11 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,996 | 🐛 16 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,438 | 🐛 396 | 🌐 Go | 📅 2026-05-11 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,246 | 🐛 461 | 🌐 Python | 📅 2026-05-11 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,245 | 🐛 127 | 🌐 Python | 📅 2026-04-27 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,370 | 🐛 254 | 🌐 Python | 📅 2026-05-11 — Check code for common misspellings.
