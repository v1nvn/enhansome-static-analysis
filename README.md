...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,451 | 🐛 19 | 🌐 Rust | 📅 2026-03-23
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,079 | 🐛 2 | 🌐 Markdown | 📅 2026-02-24.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,125 | 🐛 44 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,804 | 🐛 70 | 🌐 Python | 📅 2026-03-02 — Automated C++ checker that follows Google's style guide.

* [clazy](https://github.com/KDE/clazy) ⭐ 729 | 🐛 0 | 🌐 C++ | 📅 2026-03-23 — Qt-oriented static code analyzer based on the Clang framework. clazy is a compiler plugin which allows clang to understand Qt semantics. You get more than 50 Qt related compiler warnings, ranging from unneeded memory allocations to misusage of API, including fix-its for automatic refactoring.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,393 | 🐛 220 | 🌐 C# | 📅 2026-02-28 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,235 | 🐛 34 | 🌐 C# | 📅 2026-03-23 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,102 | 🐛 4 | 🌐 C# | 📅 2026-03-22 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 897 | 🐛 242 | 🌐 C# | 📅 2026-03-24 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,826 | 🐛 109 | 🌐 Clojure | 📅 2026-03-17 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [DelphiLint](https://github.com/integrated-application-development/delphilint) ⭐ 134 | 🐛 11 | 🌐 Pascal | 📅 2026-01-27 — A Delphi IDE package providing on-the-fly code analysis and linting, powered by SonarDelphi.
...
* [D-scanner](https://github.com/dlang-community/D-Scanner) ⭐ 251 | 🐛 128 | 🌐 D | 📅 2026-02-18 — D-Scanner is a tool for analyzing D source code.

<a name="elixir" />
<h2>Elixir</h2>

* [credo](https://github.com/rrrene/credo) ⭐ 5,147 | 🐛 29 | 🌐 Elixir | 📅 2026-03-23 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,786 | 🐛 78 | 🌐 Elixir | 📅 2025-11-06 — Mix tasks to simplify use of Dialyzer in Elixir projects.

* [sobelow](https://github.com/nccgroup/sobelow) ⭐ 1,775 | 🐛 37 | 🌐 Elixir | 📅 2024-08-20 — Security-focused static analysis for the Phoenix Framework.
...
* [elvis](https://github.com/inaka/elvis) ⭐ 429 | 🐛 3 | 🌐 Erlang | 📅 2026-03-23 — Erlang Style Reviewer.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 319 | 🐛 94 | 🌐 F# | 📅 2026-02-12 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,157 | 🐛 138 | 🌐 Go | 📅 2026-03-24 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,893 | 🐛 29 | 🌐 Go | 📅 2026-02-18 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) ⭐ 3,130 | 🐛 30 | 🌐 Go | 📅 2018-10-27 — Concurrently runs many linters and normalises their output to a report.

* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,474 | 🐛 14 | 🌐 Go | 📅 2026-02-26 — Check that error return values are used.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,036 | 🐛 147 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.

* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,551 | 🐛 10 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.

* [misspell](https://github.com/client9/misspell) ⚠️ Archived — Finds commonly misspelled English words.

* [structslop](https://github.com/orijtech/structslop) ⭐ 834 | 🐛 11 | 🌐 Go | 📅 2024-02-08 — Static analyzer for Go that recommends struct field rearrangements to provide for maximum space/allocation efficiency

* [prealloc](https://github.com/alexkohler/prealloc) ⭐ 664 | 🐛 3 | 🌐 Go | 📅 2026-02-26 — Finds slice declarations that could potentially be preallocated.

* [unparam](https://github.com/mvdan/unparam) ⭐ 568 | 🐛 10 | 🌐 Go | 📅 2025-10-27 — Find unused function parameters.

* [goroutine-inspect](https://github.com/linuxerwang/goroutine-inspect) ⭐ 477 | 🐛 1 | 🌐 Go | 📅 2021-12-06 — An interactive tool to analyze Golang goroutine dump.

* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 456 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.

* [errwrap](https://github.com/fatih/errwrap) ⭐ 381 | 🐛 1 | 🌐 Go | 📅 2025-04-07 — Wrap and fix Go errors with the new %w verb directive.  This tool analyzes fmt.Errorf() calls and reports calls that contain a verb directive that  is different than the new %w verb directive introduced in Go v1.13.  It's also capable of rewriting calls to use the new %w wrap verb directive.

* [dupl](https://github.com/mibk/dupl) ⭐ 366 | 🐛 5 | 🌐 Go | 📅 2026-03-05 — Reports potentially duplicated code.

* [wsl](https://github.com/bombsimon/wsl) ⭐ 346 | 🐛 5 | 🌐 Go | 📅 2026-03-22 — Enforces empty lines at the right places.

* [bodyclose](https://github.com/timakin/bodyclose) ⭐ 324 | 🐛 29 | 🌐 Go | 📅 2026-01-29 — Checks whether HTTP response body is closed.

* [goconst](https://github.com/jgautheron/goconst) ⭐ 315 | 🐛 3 | 🌐 Go | 📅 2026-03-06 — Finds repeated strings that could be replaced by a constant.
...
* [dogsled](https://github.com/alexkohler/dogsled) ⭐ 74 | 🐛 1 | 🌐 Go | 📅 2024-03-29 — Finds assignments/declarations with too many blank identifiers.

* [lll](https://github.com/walle/lll) ⭐ 70 | 🐛 7 | 🌐 Go | 📅 2022-06-04 — Report long lines.

* [goast](https://github.com/m-mizutani/goast) ⭐ 63 | 🐛 1 | 🌐 Go | 📅 2026-03-20 — Go AST (Abstract Syntax Tree) based static analysis tool with Rego.

* [deadcode](https://github.com/tsenart/deadcode) ⭐ 53 | 🐛 8 | 🌐 Go | 📅 2018-10-28 — Finds unused code.

* [flen](https://github.com/lafolle/flen) ⭐ 50 | 🐛 3 | 🌐 Go | 📅 2018-03-11 — Get info on length of functions in a Go package.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,585 | 🐛 291 | 🌐 Haskell | 📅 2026-03-22 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,096 | 🐛 165 | 🌐 Java | 📅 2026-03-20 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,024 | 🐛 140 | 🌐 Java | 📅 2026-03-24 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,134 | 🐛 429 | 🌐 Java | 📅 2026-03-23 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 522 | 🐛 59 | 🌐 Java | 📅 2026-03-19 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.

* [ck](https://github.com/mauricioaniche/ck) ⭐ 448 | 🐛 31 | 🌐 Java | 📅 2026-01-22 — Calculates Chidamber and Kemerer object-oriented metrics by processing the source Java files.

* [forbidden-apis](https://github.com/policeman-tools/forbidden-apis) ⭐ 362 | 🐛 30 | 🌐 Java | 📅 2025-10-05 — Detects and forbids invocations of specific method/class/field (like reading from a text stream without a charset). Maven/Gradle/Ant compatible.

* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 155 | 🐛 10 | 🌐 Java | 📅 2026-03-22 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.

* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 27 | 🐛 18 | 🌐 Java | 📅 2026-03-17 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 75 | 🐛 30 | 🌐 Java | 📅 2026-03-20 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,451 | 🐛 19 | 🌐 Rust | 📅 2026-03-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,968 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-14 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,668 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,451 | 🐛 19 | 🌐 Rust | 📅 2026-03-23 — The JavaScript Code Quality Tool.

* [Polymer-analyzer](https://github.com/Polymer/tools/tree/master/packages/analyzer) ⭐ 436 | 🐛 840 | 🌐 TypeScript | 📅 2026-03-18 — A static analysis framework for Web Components.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 856 | 🐛 90 | 🌐 Julia | 📅 2026-03-23 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-03-24 — Static Code Analysis for Julia
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 442 | 🐛 41 | 🌐 Lua | 📅 2026-03-16 — A tool for linting and static analysis of Lua code.
...
* [VeriFast](https://github.com/verifast/verifast) ⭐ 481 | 🐛 119 | 🌐 Rust | 📅 2026-03-19 — A tool for modular formal verification of correctness properties of single-threaded and multithreaded  C and Java programs annotated with preconditions and postconditions written in separation logic.  To express rich specifications, the programmer can define inductive datatypes,  primitive recursive pure functions over these datatypes, and abstract separation logic predicates.
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 604 | 🐛 18 | 🌐 PHP | 📅 2026-01-28 — Fast detection of composer dependency issues.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,425 | 🐛 65 | 🌐 PHP | 📅 2026-02-26 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,787 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,483 | 🐛 85 | 🌐 PHP | 📅 2026-03-22.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,339 | 🐛 115 | 🌐 PHP | 📅 2026-03-19 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,607 | 🐛 795 | 🌐 PHP | 📅 2026-03-24 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,586 | 🐛 69 | 🌐 PHP | 📅 2026-02-23 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,277 | 🐛 6 | 🌐 PHP | 📅 2026-02-03 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,910 | 🐛 28 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,304 | 🐛 3 | 🌐 Dockerfile | 📅 2026-03-23 — Many tools for PHP static analysis in one container.

* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,245 | 🐛 10 | 🌐 PHP | 📅 2026-03-17 — Easy to use architecture testing tool for PHP.

* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 884 | 🐛 34 | 🌐 PHP | 📅 2026-03-23 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.

* [phpmnd](https://github.com/povils/phpmnd) ⭐ 580 | 🐛 21 | 🌐 PHP | 📅 2026-02-25 — Helps to detect magic numbers.

* [dephpend](https://github.com/mihaeu/dephpend) ⭐ 534 | 🐛 5 | 🌐 PHP | 📅 2026-01-28 — Dependency analysis tool.
...
* [Progpilot](https://github.com/designsecurity/progpilot) ⭐ 360 | 🐛 4 | 🌐 PHP | 📅 2025-08-17 — A static analysis tool for security purposes.

* [parallel-lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) ⭐ 350 | 🐛 28 | 🌐 PHP | 📅 2026-03-19 — This tool checks syntax of PHP files faster than serial check with a fancier output.
...
* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 126 | 🐛 11 | 🌐 PHP | 📅 2026-03-20 — Reflection library to do Static Analysis for PHP Projects
...
* [zarn](https://github.com/htrgouvea/zarn) ⭐ 56 | 🐛 4 | 🌐 Perl | 📅 2026-03-21 — A lightweight static security analysis tool for modern Perl Apps

<a name="python" />
<h2>Python</h2>

* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,331 | 🐛 235 | 🌐 Python | 📅 2026-03-21 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,997 | 🐛 73 | 🌐 Python | 📅 2026-02-11.

* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,394 | 🐛 57 | 🌐 Python | 📅 2026-03-04 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,772 | 🐛 23 | 🌐 Python | 📅 2025-12-22 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,530 | 🐛 29 | 🌐 Python | 📅 2026-02-21 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,075 | 🐛 34 | 🌐 Python | 📅 2026-03-23 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,950 | 🐛 50 | 🌐 Python | 📅 2024-10-20.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,274 | 🐛 47 | 🌐 Python | 📅 2026-03-16 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,217 | 🐛 61 | 🌐 Python | 📅 2026-03-18 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.

* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 952 | 🐛 42 | 🌐 Python | 📅 2026-03-12 — Autoflake removes unused imports and unused variables from Python code.
...
* [pyroma](https://github.com/regebro/pyroma) ⭐ 232 | 🐛 7 | 🌐 Python | 📅 2025-12-09 — Rate how well a Python project complies with the best practices of the Python packaging ecosystem, and list issues that could be improved.
...
* [Dodgy](https://github.com/landscapeio/dodgy) ⭐ 127 | 🐛 11 | 🌐 Python | 📅 2021-08-29 — Dodgy is a very basic tool to run against your codebase to search for "dodgy" looking values. It is a series of simple regular expressions designed to detect things such as accidental SCM diff checkins, or passwords or secret keys hard coded into files.

* [Pyra](https://github.com/spangea/Pyra) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2025-12-11 — Pyra is a high-level linter static analyzer for data science applications written in Python, that helps developers identify potential issues in their data science code written in Python, as an extension of [Lyra](https://github.com/caterinaurban/Lyra) ⭐ 31 | 🐛 2 | 🌐 Python | 📅 2025-08-18.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 368 | 🐛 135 | 🌐 Go | 📅 2026-03-23 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,891 | 🐛 39 | 🌐 Ruby | 📅 2026-03-23 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,742 | 🐛 55 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,055 | 🐛 22 | 🌐 Ruby | 📅 2026-03-18.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,911 | 🐛 27 | 🌐 Ruby | 📅 2026-01-12 — Identify database issues before they hit production.

* [Fasterer](https://github.com/DamirSvrtan/fasterer) ⭐ 1,822 | 🐛 12 | 🌐 Ruby | 📅 2024-06-14 — Common Ruby idioms checker.

* [Steep](https://github.com/soutaro/steep) ⭐ 1,480 | 🐛 222 | 🌐 Ruby | 📅 2026-03-23 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,170 | 🐛 3 | 🌐 Ruby | 📅 2026-03-24 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.

* [rufo](https://github.com/ruby-formatter/rufo) ⭐ 934 | 🐛 34 | 🌐 Ruby | 📅 2025-12-25 — An opinionated ruby formatter, intended to be used via the command line as a text-editor plugin, to autoformat files on save or on demand.
...
* [ERB Lint](https://github.com/Shopify/erb-lint) ⭐ 742 | 🐛 88 | 🌐 Ruby | 📅 2026-03-23 — Lint your ERB or HTML files
...
* [Skunk](https://github.com/fastruby/skunk) ⭐ 543 | 🐛 9 | 🌐 Ruby | 📅 2026-02-06 — A SkunkScore Calculator for Ruby Code -- Find the most complicated code without test coverage!
...
* [htmlbeautifier](https://github.com/threedaymonk/htmlbeautifier) ⭐ 371 | 🐛 18 | 🌐 Ruby | 📅 2024-02-13 — A normaliser/beautifier for HTML that also understands embedded Ruby. Ideal for tidying up Rails templates.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,052 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 2,992 | 🐛 478 | 🌐 Rust | 📅 2026-03-23 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,086 | 🐛 40 | 🌐 Rust | 📅 2025-12-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.

* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,569 | 🐛 52 | 🌐 Rust | 📅 2026-01-11 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,092 | 🐛 100 | 📅 2026-03-24.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 932 | 🐛 24 | 🌐 Rust | 📅 2026-03-16 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code

* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 650 | 🐛 39 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.

* [cargo-spellcheck](https://github.com/drahnr/cargo-spellcheck) ⭐ 358 | 🐛 58 | 🌐 Rust | 📅 2026-03-16 — Checks all your documentation for spelling and grammar mistakes  with hunspell (ready) and languagetool (preview)
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,782 | 🐛 914 | 🌐 Rust | 📅 2026-03-21 — A tool for formatting Rust code according to style guidelines.

* [RustViz](https://github.com/rustviz/rustviz) ⭐ 2,827 | 🐛 24 | 🌐 HTML | 📅 2024-02-13 — RustViz is a tool that generates visualizations  from simple Rust programs to assist users in better  understanding the Rust Lifetime and Borrowing mechanism. It generates SVG files with graphical indicators that integrate  with mdbook to render visualizations of data-flow in Rust programs.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 815 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [lockbud](https://github.com/BurtonQin/lockbud) ⭐ 588 | 🐛 27 | 🌐 Rust | 📅 2026-03-02 — Statically detects Rust deadlocks bugs. It currently detects two common kinds of deadlock bugs: doublelock and locks in conflicting order. It will print bugs in JSON format together with the source code location and an explanation of each bug.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 131 | 🐛 5 | 🌐 Python | 📅 2026-03-21 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 554 | 🐛 49 | 🌐 Scala | 📅 2026-03-17 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,761 | 🐛 8 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.

* [bashate](https://github.com/openstack/bashate) ⭐ 394 | 🐛 0 | 🌐 Python | 📅 2024-11-26 — Code style enforcement for bash programs. The output format aims to follow pycodestyle (pep8) default output format.

* [kmdr](https://github.com/ediardo/kmdr-cli) ⭐ 19 | 🐛 0 | 📅 2022-02-27 — CLI tool for learning commands from your terminal. kmdr delivers a break down of commands with every attribute explained.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,741 | 🐛 314 | 🌐 Swift | 📅 2026-03-24 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,164 | 🐛 301 | 🌐 TypeScript | 📅 2026-03-24 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,779 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-22 — Linter for Angular projects

* [TypeScript Call Graph](https://github.com/whyboris/TypeScript-Call-Graph) ⭐ 284 | 🐛 10 | 🌐 JavaScript | 📅 2025-10-26 — CLI to generate an interactive graph of functions and calls from your TypeScript files
...
* [svls](https://github.com/dalance/svls) ⭐ 567 | 🐛 26 | 🌐 Rust | 📅 2026-03-23 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 359 | 🐛 77 | 🌐 TypeScript | 📅 2026-03-23 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 71 | 🐛 1 | 🌐 Rust | 📅 2026-03-20 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 33,867 | 🐛 234 | 🌐 Go | 📅 2026-03-19 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,224 | 🐛 99 | 🌐 JavaScript | 📅 2026-03-23 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,274 | 🐛 596 | 🌐 Rust | 📅 2026-03-24 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,980 | 🐛 596 | 🌐 Vim Script | 📅 2026-02-28 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,377 | 🐛 1,332 | 🌐 CodeQL | 📅 2026-03-23 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,245 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.

* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,386 | 🐛 26 | 🌐 C# | 📅 2026-02-17 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,968 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,662 | 🐛 14 | 🌐 Ruby | 📅 2026-03-23 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,601 | 🐛 18 | 🌐 Go | 📅 2026-03-23 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.

* [weggli](https://github.com/googleprojectzero/weggli) ⭐ 2,484 | 🐛 47 | 🌐 Rust | 📅 2024-07-12 — A fast and robust semantic search tool for C and C++ codebases. It is designed to help security researchers identify interesting functionality in large codebases.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,297 | 🐛 52 | 🌐 Python | 📅 2026-03-02 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.

* [TscanCode](https://github.com/Tencent/TscanCode) ⭐ 2,116 | 🐛 57 | 🌐 C++ | 📅 2023-12-25 — A fast and accurate static analysis solution for C/C++, C#, Lua codes provided by Tencent. Using GPLv3 license.

* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,944 | 🐛 196 | 📅 2026-03-23 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,670 | 🐛 1,054 | 📅 2026-03-23 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 976 | 🐛 68 | 🌐 C# | 📅 2026-03-13 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 837 | 🐛 147 | 🌐 Java | 📅 2026-03-20 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 781 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-23 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [sqlvet](https://github.com/houqp/sqlvet) ⭐ 498 | 🐛 9 | 🌐 Go | 📅 2026-02-16 — Performs static analysis on raw SQL queries in your Go code base to surface potential runtime errors. It checks for SQL syntax error, identifies unsafe queries that could potentially lead to SQL injections makes sure column count matches value count in INSERT statements and validates table- and column names.

* [todocheck](https://github.com/preslavmihaylov/todocheck) ⭐ 435 | 🐛 13 | 🌐 Go | 📅 2025-08-02 — Linter for integrating annotated TODOs with your issue trackers

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 349 | 🐛 4 | 🌐 Python | 📅 2026-03-23 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.

* [callGraph](https://github.com/koknat/callGraph) ⭐ 328 | 🐛 6 | 🌐 Perl | 📅 2024-11-20 — Statically generates a call graph image and displays it on screen.

* [Depends](https://github.com/multilang-depends/depends) ⭐ 247 | 🐛 12 | 🌐 Java | 📅 2026-02-23 — Analyses the comprehensive dependencies of code elements for Java, C/C++, Ruby.

* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 217 | 🐛 5 | 🌐 Go | 📅 2026-03-20 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 107 | 🐛 12 | 🌐 Rust | 📅 2026-03-23 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.

* [relint](https://github.com/codingjoe/relint) ⭐ 65 | 🐛 0 | 🌐 Python | 📅 2026-03-02 — A static file linter that allows you to write custom rules using regular expressions (RegEx).

* [OpenStaticAnalyzer](https://github.com/sed-inf-u-szeged/OpenStaticAnalyzer) ⭐ 49 | 🐛 2 | 🌐 C++ | 📅 2022-11-09 — OpenStaticAnalyzer is a source code analyzer tool, which can perform deep static analysis of the source code of complex systems.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 24 | 🐛 0 | 🌐 Rust | 📅 2026-03-21 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,562 | 🐛 596 | 🌐 Python | 📅 2026-03-24 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,401 | 🐛 62 | 🌐 C++ | 📅 2026-03-20 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,113 | 🐛 6 | 🌐 YARA | 📅 2026-03-11 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 842 | 🐛 155 | 🌐 C# | 📅 2026-03-24 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 815 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 571 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-03-23 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.

* [VMware chap](https://github.com/vmware/chap) ⭐ 391 | 🐛 8 | 🌐 C++ | 📅 2025-06-01 — chap analyzes un-instrumented ELF core files for leaks, memory growth, and corruption.  It is sufficiently reliable that it can be used in automation to catch leaks before  they are committed. As an interactive tool, it helps explain memory growth,  can identify some forms of corruption, and supplements a debugger  by giving the status of various memory locations.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,179 | 🐛 31 | 🌐 Go | 📅 2026-03-16 — Linter / Analyzer for Makefiles.
...
* [CSScomb](https://github.com/csscomb/csscomb.js) ⭐ 3,327 | 🐛 109 | 🌐 JavaScript | 📅 2023-01-03 — A coding style formatter for CSS. Supports own configurations to make style sheets beautiful and consistent.

* [Specificity Graph](https://github.com/pocketjoso/specificity-graph) ⭐ 701 | 🐛 3 | 🌐 JavaScript | 📅 2016-04-16 — CSS Specificity Graph Generator.
...
* [gixy](https://github.com/yandex/gixy) ⭐ 8,546 | 🐛 57 | 🌐 Python | 📅 2024-07-28 — A tool to analyze Nginx configuration. The main goal is to prevent misconfiguration and automate flaw detection.

<a name="configmanagement" />
<h2>Configuration Management</h2>

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,966 | 🐛 14 | 🌐 Go | 📅 2026-03-19 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,611 | 🐛 101 | 🌐 Python | 📅 2026-03-23 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,371 | 🐛 51 | 🌐 Rust | 📅 2026-03-03 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.

* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,305 | 🐛 84 | 🌐 Ruby | 📅 2024-08-01 — A linter for AWS CloudFormation templates.

* [metadata-json-lint](https://github.com/voxpupuli/metadata-json-lint) ⭐ 31 | 🐛 12 | 🌐 Ruby | 📅 2026-03-18 — Tool to check the validity of Puppet metadata.json files.
...
* [tflint](https://github.com/wata727/tflint) ⭐ 0 | 🐛 0 | 📅 2026-03-21 — A Terraform linter for detecting errors that can not be detected by `terraform plan`.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,012 | 🐛 256 | 🌐 Haskell | 📅 2026-03-09 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,787 | 🐛 382 | 🌐 Go | 📅 2026-03-24 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,947 | 🐛 55 | 🌐 Go | 📅 2026-03-19 — Vulnerability Static Analysis for Containers.

* [krane](https://github.com/appvia/krane) ⭐ 737 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,582 | 🐛 180 | 🌐 Rust | 📅 2026-01-31 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 79 | 🐛 6 | 🌐 Python | 📅 2026-03-23 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [gherkin-lint](https://github.com/vsiakka/gherkin-lint) ⭐ 194 | 🐛 76 | 🌐 JavaScript | 📅 2024-08-19 — A linter for the Gherkin-Syntax written in Javascript.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,420 | 🐛 73 | 🌐 Go | 📅 2026-03-19 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,966 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,622 | 🐛 14 | 🌐 Go | 📅 2026-03-16 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.

* [krane](https://github.com/appvia/krane) ⭐ 737 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
  It identifies potential security risks in K8s RBAC design and makes suggestions on how to mitigate them. Krane dashboard presents current RBAC security posture and lets you navigate through its definition.

* [clusterlint](https://github.com/digitalocean/clusterlint) ⭐ 586 | 🐛 11 | 🌐 Go | 📅 2026-02-04 — Clusterlint queries live Kubernetes clusters for resources, executes common and  platform specific checks against these resources and provides actionable feedback to cluster operators.  It is a non invasive tool that is run externally. Clusterlint does not alter the resource configurations.

* [kube-lint](https://github.com/viglesiasce/kube-lint) ⭐ 155 | 🐛 5 | 🌐 Go | 📅 2023-05-11 — A linter for Kubernetes resources with a customizable rule set. You define a list of rules that you would like to validate against your  resources and kube-lint will evaluate those rules against them.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,420 | 🐛 73 | 🌐 Go | 📅 2026-03-19 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,951 | 🐛 82 | 🌐 JavaScript | 📅 2026-03-23 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,021 | 🐛 153 | 🌐 Ruby | 📅 2025-12-01 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 102 | 🐛 16 | 🌐 Rust | 📅 2026-03-23 — Format markdown code blocks using your favorite code formatters.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,235 | 🐛 241 | 🌐 Java | 📅 2026-03-17 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 853 | 🐛 46 | 🌐 Rust | 📅 2026-03-20 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 735 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)

<a name="nodejs" />
<h2>Node.js</h2>

* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 845 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-25 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 90 | 🌐 Python | 📅 2026-03-23 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 679 | 🐛 53 | 🌐 Go | 📅 2026-03-21 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,533 | 🐛 349 | 🌐 Go | 📅 2026-03-21 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,787 | 🐛 382 | 🌐 Go | 📅 2026-03-24 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,452 | 🐛 142 | 🌐 Python | 📅 2025-03-13 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,554 | 🐛 6 | 🌐 Java | 📅 2026-02-19 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,966 | 🐛 14 | 🌐 Go | 📅 2026-03-19 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,321 | 🐛 381 | 🌐 Go | 📅 2026-03-24 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,172 | 🐛 440 | 🌐 Python | 📅 2026-03-23 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,216 | 🐛 125 | 🌐 Python | 📅 2026-03-17 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [haml-lint](https://github.com/sds/haml-lint) ⭐ 335 | 🐛 11 | 🌐 Ruby | 📅 2026-03-23 — Tool for writing clean and consistent HAML.

* [ember-template-lint](https://github.com/ember-template-lint/ember-template-lint) ⭐ 265 | 🐛 176 | 🌐 JavaScript | 📅 2025-12-01 — Linter for Ember or Handlebars templates.

* [slim-lint](https://github.com/sds/slim-lint) ⭐ 225 | 🐛 21 | 🌐 Ruby | 📅 2026-03-03 — Configurable tool for analyzing Slim templates.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 50 | 🐛 24 | 🌐 Python | 📅 2026-03-17 — A set of utilities for working with PO files to ease development and improve quality.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,520 | 🐛 247 | 🌐 JavaScript | 📅 2026-03-18 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,340 | 🐛 253 | 🌐 Python | 📅 2026-03-23 — Check code for common misspellings.

* [misspell-fixer](https://github.com/vlajos/misspell-fixer) ⭐ 197 | 🐛 3 | 🌐 sed | 📅 2025-09-19 — Quick tool for fixing common misspellings, typos in source code.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,736 | 🐛 571 | 🌐 Go | 📅 2026-02-25 — A collection of tools and libraries for working with Go code, including linters and static analysis
* [php-static-analysis-tools](https://github.com/exakat/php-static-analysis-tools) ⭐ 2,872 | 🐛 5 | 📅 2025-01-28 — A reviewed list of useful PHP static analysis tools
* [linters](https://github.com/mcandre/linters) ⭐ 349 | 🐛 59 | 📅 2026-03-17 — An introduction to static code analysis
