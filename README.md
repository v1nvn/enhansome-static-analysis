...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,376 | 🐛 3 | 🌐 Rust | 📅 2026-02-11
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,376 | 🐛 213 | 🌐 C# | 📅 2026-02-07 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,182 | 🐛 34 | 🌐 C# | 📅 2026-02-12 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.
...
* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 892 | 🐛 238 | 🌐 C# | 📅 2026-02-12 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,141 | 🐛 31 | 🌐 Elixir | 📅 2026-02-08 — A static code analysis tool with a focus on code consistency and teaching.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 321 | 🐛 90 | 🌐 F# | 📅 2026-02-11 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,068 | 🐛 141 | 🌐 Go | 📅 2026-02-12 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,849 | 🐛 29 | 🌐 Go | 📅 2025-12-20 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [prealloc](https://github.com/alexkohler/prealloc) ⭐ 662 | 🐛 5 | 🌐 Go | 📅 2026-02-11 — Finds slice declarations that could potentially be preallocated.
...
* [wsl](https://github.com/bombsimon/wsl) ⭐ 340 | 🐛 2 | 🌐 Go | 📅 2026-02-10 — Enforces empty lines at the right places.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,068 | 🐛 165 | 🌐 Java | 📅 2026-02-05 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,007 | 🐛 131 | 🌐 Java | 📅 2026-02-12 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,127 | 🐛 427 | 🌐 Java | 📅 2026-02-11 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,376 | 🐛 3 | 🌐 Rust | 📅 2026-02-11 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,658 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-01 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,376 | 🐛 3 | 🌐 Rust | 📅 2026-02-11 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 846 | 🐛 93 | 🌐 Julia | 📅 2026-02-02 — Static type inference system to detect bugs and type instabilities.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,791 | 🐛 269 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,459 | 🐛 85 | 🌐 PHP | 📅 2026-02-11.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,302 | 🐛 108 | 🌐 PHP | 📅 2026-02-02 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,603 | 🐛 797 | 🌐 PHP | 📅 2026-02-09 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,577 | 🐛 71 | 🌐 PHP | 📅 2025-11-12 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,219 | 🐛 206 | 🌐 Python | 📅 2026-02-07 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,988 | 🐛 65 | 🌐 Python | 📅 2026-02-11.

* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,319 | 🐛 55 | 🌐 Python | 📅 2025-11-25 — Find unused classes, functions and variables in Python code.
...
* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,063 | 🐛 33 | 🌐 Python | 📅 2026-02-10 — A wrapper around `pylint`, `pep8`, `mccabe` and others.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 360 | 🐛 143 | 🌐 Go | 📅 2026-02-11 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,739 | 🐛 52 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,052 | 🐛 19 | 🌐 Ruby | 📅 2026-02-11.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,471 | 🐛 180 | 🌐 Ruby | 📅 2026-02-10 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 2,903 | 🐛 482 | 🌐 Rust | 📅 2026-02-11 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,078 | 🐛 99 | 📅 2026-02-11.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 922 | 🐛 27 | 🌐 Rust | 📅 2026-02-09 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,733 | 🐛 909 | 🌐 Rust | 📅 2026-02-12 — A tool for formatting Rust code according to style guidelines.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 554 | 🐛 50 | 🌐 Scala | 📅 2026-02-10 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,747 | 🐛 8 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,093 | 🐛 302 | 🌐 TypeScript | 📅 2026-02-11 — TypeScript language extension for eslint.
...
* [svls](https://github.com/dalance/svls) ⭐ 560 | 🐛 27 | 🌐 Rust | 📅 2026-02-11 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 352 | 🐛 77 | 🌐 TypeScript | 📅 2026-02-10 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 68 | 🐛 3 | 🌐 Rust | 📅 2026-02-11 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 31,873 | 🐛 214 | 🌐 Go | 📅 2026-02-11 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 26,884 | 🐛 94 | 🌐 JavaScript | 📅 2026-02-09 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 18,937 | 🐛 421 | 🌐 Rust | 📅 2026-02-12 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,959 | 🐛 585 | 🌐 Vim Script | 📅 2026-02-12 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,228 | 🐛 1,292 | 🌐 CodeQL | 📅 2026-02-12 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,559 | 🐛 27 | 🌐 Go | 📅 2026-02-09 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,947 | 🐛 195 | 📅 2026-02-12 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,668 | 🐛 1,055 | 📅 2026-02-09 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 970 | 🐛 65 | 🌐 C# | 📅 2026-02-06 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 36 | 🐛 6 | 🌐 Go | 📅 2026-01-31 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,489 | 🐛 587 | 🌐 Python | 📅 2026-02-12 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,363 | 🐛 61 | 🌐 C++ | 📅 2026-01-31 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 839 | 🐛 154 | 🌐 C# | 📅 2026-02-11 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 796 | 🐛 16 | 🌐 Rust | 📅 2025-11-09 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 570 | 🐛 2 | 🌐 C++ | 📅 2026-02-11 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,170 | 🐛 31 | 🌐 Go | 📅 2026-02-09 — Linter / Analyzer for Makefiles.
...
* [tflint](https://github.com/wata727/tflint) ⭐ 5,609 | 🐛 28 | 🌐 Go | 📅 2026-02-09 — A Terraform linter for detecting errors that can not be detected by `terraform plan`.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,610 | 🐛 103 | 🌐 Python | 📅 2026-02-11 — AWS Labs CloudFormation linter.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 11,940 | 🐛 249 | 🌐 Haskell | 📅 2026-01-27 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,528 | 🐛 353 | 🌐 Go | 📅 2026-02-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,927 | 🐛 49 | 🌐 Go | 📅 2026-02-10 — Vulnerability Static Analysis for Containers.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,394 | 🐛 79 | 🌐 Go | 📅 2026-02-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,922 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,394 | 🐛 79 | 🌐 Go | 📅 2026-02-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,830 | 🐛 80 | 🌐 JavaScript | 📅 2026-02-12 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,004 | 🐛 154 | 🌐 Ruby | 📅 2025-12-01 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 96 | 🐛 16 | 🌐 Rust | 📅 2026-02-10 — Format markdown code blocks using your favorite code formatters.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,223 | 🐛 243 | 🌐 Java | 📅 2026-02-10 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 820 | 🐛 46 | 🌐 Rust | 📅 2026-02-06 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 714 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 161 | 🐛 87 | 🌐 Python | 📅 2026-02-11 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 24,875 | 🐛 345 | 🌐 Go | 📅 2026-01-08 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,528 | 🐛 353 | 🌐 Go | 📅 2026-02-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,419 | 🐛 137 | 🌐 Python | 📅 2025-03-13 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,262 | 🐛 382 | 🌐 Go | 📅 2026-02-10 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,131 | 🐛 428 | 🌐 Python | 📅 2026-02-11 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,199 | 🐛 123 | 🌐 Python | 📅 2026-02-09 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,330 | 🐛 249 | 🌐 Python | 📅 2026-02-06 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,715 | 🐛 593 | 🌐 Go | 📅 2026-01-20 — A collection of tools and libraries for working with Go code, including linters and static analysis
