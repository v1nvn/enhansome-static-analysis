...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,538 | 🐛 43 | 🌐 Rust | 📅 2026-05-07
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,085 | 🐛 2 | 🌐 Markdown | 📅 2026-05-03.
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,283 | 🐛 36 | 🌐 C# | 📅 2026-05-10 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,129 | 🐛 2 | 🌐 C# | 📅 2026-05-08 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 905 | 🐛 242 | 🌐 C# | 📅 2026-05-09 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,177 | 🐛 28 | 🌐 Elixir | 📅 2026-05-05 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,789 | 🐛 80 | 🌐 Elixir | 📅 2025-11-06 — Mix tasks to simplify use of Dialyzer in Elixir projects.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,283 | 🐛 145 | 🌐 Go | 📅 2026-05-10 — A tool for posting review comments from any linter in any code hosting service.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,489 | 🐛 17 | 🌐 Go | 📅 2026-04-26 — Check that error return values are used.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,130 | 🐛 167 | 🌐 Java | 📅 2026-04-30 — Reformats Java source code to comply with Google Java Style
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,538 | 🐛 43 | 🌐 Rust | 📅 2026-05-07 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,663 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,538 | 🐛 43 | 🌐 Rust | 📅 2026-05-07 — The JavaScript Code Quality Tool.
...
* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-05-11 — Static Code Analysis for Julia
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,772 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,508 | 🐛 84 | 🌐 PHP | 📅 2026-05-08.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,392 | 🐛 130 | 🌐 PHP | 📅 2026-04-22 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,290 | 🐛 10 | 🌐 PHP | 📅 2026-04-16 — Checks code on every commit.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,315 | 🐛 3 | 🌐 Dockerfile | 📅 2026-05-10 — Many tools for PHP static analysis in one container.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,422 | 🐛 259 | 🌐 Python | 📅 2026-05-08 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,593 | 🐛 56 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,784 | 🐛 23 | 🌐 Python | 📅 2026-04-28 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* [wily](https://github.com/tonybaloney/wily) ⭐ 1,287 | 🐛 34 | 🌐 Python | 📅 2026-05-10 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,896 | 🐛 44 | 🌐 Ruby | 📅 2026-05-05 — Ruby Style Guide, with linter & automatic code fixer
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,483 | 🐛 211 | 🌐 Ruby | 📅 2026-05-05 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,068 | 🐛 471 | 🌐 Rust | 📅 2026-05-11 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,099 | 🐛 41 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,112 | 🐛 110 | 📅 2026-05-08.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,829 | 🐛 927 | 🌐 Rust | 📅 2026-04-29 — A tool for formatting Rust code according to style guidelines.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,241 | 🐛 309 | 🌐 TypeScript | 📅 2026-05-09 — TypeScript language extension for eslint.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,929 | 🐛 256 | 🌐 Go | 📅 2026-05-08 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,241 | 🐛 109 | 🌐 JavaScript | 📅 2026-05-11 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 21,066 | 🐛 626 | 🌐 Rust | 📅 2026-05-11 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,987 | 🐛 596 | 🌐 Vim Script | 📅 2026-04-15 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,572 | 🐛 1,387 | 🌐 CodeQL | 📅 2026-05-11 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,264 | 🐛 143 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,649 | 🐛 24 | 🌐 Go | 📅 2026-05-11 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [WALA](https://github.com/wala/WALA) ⭐ 845 | 🐛 151 | 🌐 Java | 📅 2026-05-08 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-10 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [angr](https://github.com/angr/angr) ⭐ 8,646 | 🐛 613 | 🌐 Python | 📅 2026-05-10 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,443 | 🐛 63 | 🌐 C++ | 📅 2026-04-24 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,994 | 🐛 16 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,611 | 🐛 68 | 🌐 Python | 📅 2026-05-10 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,178 | 🐛 363 | 🌐 Go | 📅 2026-05-09 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,129 | 🐛 244 | 🌐 Haskell | 📅 2026-05-04 — A smarter Dockerfile linter that helps you build best practice Docker images.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,056 | 🐛 82 | 🌐 JavaScript | 📅 2026-05-11 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 26,807 | 🐛 371 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,436 | 🐛 394 | 🌐 Go | 📅 2026-05-08 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,245 | 🐛 459 | 🌐 Python | 📅 2026-04-29 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,244 | 🐛 127 | 🌐 Python | 📅 2026-04-27 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,370 | 🐛 254 | 🌐 Python | 📅 2026-04-29 — Check code for common misspellings.
