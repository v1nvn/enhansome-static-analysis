...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,523 | 🐛 39 | 🌐 Rust | 📅 2026-04-23
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,814 | 🐛 72 | 🌐 Python | 📅 2026-04-19 — Automated C++ checker that follows Google's style guide.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,417 | 🐛 224 | 🌐 C# | 📅 2026-03-25 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,278 | 🐛 36 | 🌐 C# | 📅 2026-05-03 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,125 | 🐛 3 | 🌐 C# | 📅 2026-05-03 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 903 | 🐛 240 | 🌐 C# | 📅 2026-05-02 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,833 | 🐛 114 | 🌐 Clojure | 📅 2026-05-01 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,174 | 🐛 27 | 🌐 Elixir | 📅 2026-04-28 — A static code analysis tool with a focus on code consistency and teaching.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 322 | 🐛 95 | 🌐 F# | 📅 2026-02-12 — Lint tool for F#.
...
* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,922 | 🐛 24 | 🌐 Go | 📅 2026-05-02 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,595 | 🐛 306 | 🌐 Haskell | 📅 2026-03-22 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,042 | 🐛 153 | 🌐 Java | 📅 2026-05-03 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,523 | 🐛 39 | 🌐 Rust | 📅 2026-04-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,664 | 🐛 7 | 🌐 JavaScript | 📅 2026-05-01 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,523 | 🐛 39 | 🌐 Rust | 📅 2026-04-23 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 860 | 🐛 93 | 🌐 Julia | 📅 2026-04-14 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-05-03 — Static Code Analysis for Julia
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,433 | 🐛 66 | 🌐 PHP | 📅 2026-02-26 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,771 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,509 | 🐛 86 | 🌐 PHP | 📅 2026-05-02.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,376 | 🐛 126 | 🌐 PHP | 📅 2026-04-22 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,615 | 🐛 794 | 🌐 PHP | 📅 2026-04-19 — A modern static analyzer from etsy.
...
* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,932 | 🐛 30 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,566 | 🐛 56 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,782 | 🐛 24 | 🌐 Python | 📅 2026-04-28 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,074 | 🐛 33 | 🌐 Python | 📅 2026-04-27 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,976 | 🐛 50 | 🌐 Python | 📅 2024-10-20.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,280 | 🐛 34 | 🌐 Python | 📅 2026-04-26 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,273 | 🐛 64 | 🌐 Python | 📅 2026-04-23 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,894 | 🐛 44 | 🌐 Ruby | 📅 2026-05-02 — Ruby Style Guide, with linter & automatic code fixer
...
* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,182 | 🐛 6 | 🌐 Ruby | 📅 2026-04-24 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,072 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,060 | 🐛 471 | 🌐 Rust | 📅 2026-04-28 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,106 | 🐛 110 | 📅 2026-05-02.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 940 | 🐛 27 | 🌐 Rust | 📅 2026-05-02 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,818 | 🐛 919 | 🌐 Rust | 📅 2026-04-29 — A tool for formatting Rust code according to style guidelines.
...
* [sleek](https://github.com/nrempel/sleek) ⭐ 278 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-18 — Sleek is a CLI tool for formatting SQL.  It helps you maintain a consistent style across your SQL code, enhancing readability and productivity. The heavy lifting is done by the sqlformat crate.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 555 | 🐛 49 | 🌐 Scala | 📅 2026-04-30 — Scala compiler plugin for static code analysis.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,227 | 🐛 305 | 🌐 TypeScript | 📅 2026-05-01 — TypeScript language extension for eslint.
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 367 | 🐛 79 | 🌐 TypeScript | 📅 2026-05-01 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 75 | 🐛 1 | 🌐 Rust | 📅 2026-05-02 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,816 | 🐛 256 | 🌐 Go | 📅 2026-05-01 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,220 | 🐛 113 | 🌐 JavaScript | 📅 2026-05-02 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,952 | 🐛 639 | 🌐 Rust | 📅 2026-05-03 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,988 | 🐛 597 | 🌐 Vim Script | 📅 2026-04-15 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,547 | 🐛 1,370 | 🌐 CodeQL | 📅 2026-05-01 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,666 | 🐛 14 | 🌐 Ruby | 📅 2026-04-27 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,639 | 🐛 19 | 🌐 Go | 📅 2026-04-28 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,350 | 🐛 54 | 🌐 Python | 📅 2026-04-24 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 225 | 🐛 3 | 🌐 Go | 📅 2026-05-01 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,631 | 🐛 608 | 🌐 Python | 📅 2026-05-03 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,435 | 🐛 61 | 🌐 C++ | 📅 2026-04-24 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 576 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 571 | 🐛 2 | 🌐 C++ | 📅 2026-05-02 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [gixy](https://github.com/yandex/gixy) ⭐ 8,558 | 🐛 56 | 🌐 Python | 📅 2024-07-28 — A tool to analyze Nginx configuration. The main goal is to prevent misconfiguration and automate flaw detection.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,611 | 🐛 69 | 🌐 Python | 📅 2026-05-02 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,122 | 🐛 400 | 🌐 Go | 📅 2026-05-01 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,101 | 🐛 240 | 🌐 Haskell | 📅 2026-04-30 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 10,973 | 🐛 47 | 🌐 Go | 📅 2026-04-27 — Vulnerability Static Analysis for Containers.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 80 | 🐛 5 | 🌐 Python | 📅 2026-04-30 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,012 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,042 | 🐛 82 | 🌐 JavaScript | 📅 2026-04-30 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,038 | 🐛 120 | 🌐 Ruby | 📅 2026-04-19 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 106 | 🐛 28 | 🌐 Rust | 📅 2026-05-01 — Format markdown code blocks using your favorite code formatters.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 893 | 🐛 46 | 🌐 Rust | 📅 2026-05-01 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 26,492 | 🐛 361 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,122 | 🐛 400 | 🌐 Go | 📅 2026-05-01 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,496 | 🐛 142 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,232 | 🐛 458 | 🌐 Python | 📅 2026-04-29 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 51 | 🐛 26 | 🌐 Python | 📅 2026-05-01 — A set of utilities for working with PO files to ease development and improve quality.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,362 | 🐛 254 | 🌐 Python | 📅 2026-04-29 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,770 | 🐛 571 | 🌐 Go | 📅 2026-04-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
