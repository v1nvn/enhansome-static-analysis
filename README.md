...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,460 | 🐛 22 | 🌐 Rust | 📅 2026-03-23
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,240 | 🐛 36 | 🌐 C# | 📅 2026-03-27 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,149 | 🐛 27 | 🌐 Elixir | 📅 2026-03-27 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,163 | 🐛 140 | 🌐 Go | 📅 2026-03-28 — A tool for posting review comments from any linter in any code hosting service.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,586 | 🐛 291 | 🌐 Haskell | 📅 2026-03-22 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,096 | 🐛 164 | 🌐 Java | 📅 2026-03-27 — Reformats Java source code to comply with Google Java Style
...
* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,135 | 🐛 432 | 🌐 Java | 📅 2026-03-28 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 27 | 🐛 18 | 🌐 Java | 📅 2026-03-17 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 77 | 🐛 30 | 🌐 Java | 📅 2026-03-20 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,460 | 🐛 22 | 🌐 Rust | 📅 2026-03-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,970 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-27 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,668 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,460 | 🐛 22 | 🌐 Rust | 📅 2026-03-23 — The JavaScript Code Quality Tool.
...
* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-03-28 — Static Code Analysis for Julia
...
* [phan](https://github.com/phan/phan/wiki) ⭐ 5,607 | 🐛 794 | 🌐 PHP | 📅 2026-03-27 — A modern static analyzer from etsy.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,742 | 🐛 55 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,055 | 🐛 21 | 🌐 Ruby | 📅 2026-03-26.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,480 | 🐛 224 | 🌐 Ruby | 📅 2026-03-27 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,000 | 🐛 477 | 🌐 Rust | 📅 2026-03-27 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,096 | 🐛 99 | 📅 2026-03-28.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,786 | 🐛 914 | 🌐 Rust | 📅 2026-03-27 — A tool for formatting Rust code according to style guidelines.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,746 | 🐛 314 | 🌐 Swift | 📅 2026-03-25 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,168 | 🐛 306 | 🌐 TypeScript | 📅 2026-03-27 — TypeScript language extension for eslint.
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,185 | 🐛 239 | 🌐 Go | 📅 2026-03-26 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,156 | 🐛 103 | 🌐 JavaScript | 📅 2026-03-27 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,370 | 🐛 595 | 🌐 Rust | 📅 2026-03-28 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 9,401 | 🐛 1,352 | 🌐 CodeQL | 📅 2026-03-27 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,248 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,304 | 🐛 53 | 🌐 Python | 📅 2026-03-02 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-27 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [angr](https://github.com/angr/angr) ⭐ 8,571 | 🐛 599 | 🌐 Python | 📅 2026-03-28 — Binary code analysis tool that also supports symbolic execution.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,611 | 🐛 63 | 🌐 Python | 📅 2026-03-27 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 11,892 | 🐛 385 | 🌐 Go | 📅 2026-03-27 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,424 | 🐛 73 | 🌐 Go | 📅 2026-03-27 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,424 | 🐛 73 | 🌐 Go | 📅 2026-03-27 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,956 | 🐛 82 | 🌐 JavaScript | 📅 2026-03-26 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [deadnix](https://github.com/astro/deadnix) ⭐ 738 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,572 | 🐛 350 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,336 | 🐛 386 | 🌐 Go | 📅 2026-03-26 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,179 | 🐛 441 | 🌐 Python | 📅 2026-03-26 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,342 | 🐛 254 | 🌐 Python | 📅 2026-03-27 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,744 | 🐛 573 | 🌐 Go | 📅 2026-03-26 — A collection of tools and libraries for working with Go code, including linters and static analysis
