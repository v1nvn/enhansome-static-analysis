...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,472 | 🐛 26 | 🌐 Rust | 📅 2026-03-23
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,131 | 🐛 45 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,806 | 🐛 70 | 🌐 Python | 📅 2026-03-30 — Automated C++ checker that follows Google's style guide.

* [clazy](https://github.com/KDE/clazy) ⭐ 731 | 🐛 0 | 🌐 C++ | 📅 2026-04-05 — Qt-oriented static code analyzer based on the Clang framework. clazy is a compiler plugin which allows clang to understand Qt semantics. You get more than 50 Qt related compiler warnings, ranging from unneeded memory allocations to misusage of API, including fix-its for automatic refactoring.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,400 | 🐛 222 | 🌐 C# | 📅 2026-03-25 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,246 | 🐛 36 | 🌐 C# | 📅 2026-04-05 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,105 | 🐛 2 | 🌐 C# | 📅 2026-04-02 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 900 | 🐛 244 | 🌐 C# | 📅 2026-04-03 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,827 | 🐛 106 | 🌐 Clojure | 📅 2026-04-04 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,154 | 🐛 27 | 🌐 Elixir | 📅 2026-04-03 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,787 | 🐛 80 | 🌐 Elixir | 📅 2025-11-06 — Mix tasks to simplify use of Dialyzer in Elixir projects.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 320 | 🐛 93 | 🌐 F# | 📅 2026-02-12 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,181 | 🐛 138 | 🌐 Go | 📅 2026-04-05 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,904 | 🐛 29 | 🌐 Go | 📅 2026-02-18 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) ⭐ 3,128 | 🐛 30 | 🌐 Go | 📅 2018-10-27 — Concurrently runs many linters and normalises their output to a report.

* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,476 | 🐛 14 | 🌐 Go | 📅 2026-02-26 — Check that error return values are used.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,037 | 🐛 149 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.
...
* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 459 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.
...
* [dupl](https://github.com/mibk/dupl) ⭐ 366 | 🐛 4 | 🌐 Go | 📅 2026-03-05 — Reports potentially duplicated code.

* [wsl](https://github.com/bombsimon/wsl) ⭐ 348 | 🐛 5 | 🌐 Go | 📅 2026-03-25 — Enforces empty lines at the right places.

* [bodyclose](https://github.com/timakin/bodyclose) ⭐ 323 | 🐛 30 | 🌐 Go | 📅 2026-01-29 — Checks whether HTTP response body is closed.

* [goconst](https://github.com/jgautheron/goconst) ⭐ 314 | 🐛 0 | 🌐 Go | 📅 2026-04-03 — Finds repeated strings that could be replaced by a constant.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,100 | 🐛 164 | 🌐 Java | 📅 2026-04-04 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,028 | 🐛 143 | 🌐 Java | 📅 2026-04-03 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 435 | 🌐 Java | 📅 2026-04-05 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [ck](https://github.com/mauricioaniche/ck) ⭐ 450 | 🐛 31 | 🌐 Java | 📅 2026-01-22 — Calculates Chidamber and Kemerer object-oriented metrics by processing the source Java files.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 28 | 🐛 18 | 🌐 Java | 📅 2026-04-03 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 79 | 🐛 30 | 🌐 Java | 📅 2026-04-01 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,472 | 🐛 26 | 🌐 Rust | 📅 2026-03-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,971 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-02 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,669 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,472 | 🐛 26 | 🌐 Rust | 📅 2026-03-23 — The JavaScript Code Quality Tool.

* [Polymer-analyzer](https://github.com/Polymer/tools/tree/master/packages/analyzer) ⭐ 436 | 🐛 864 | 🌐 TypeScript | 📅 2026-04-02 — A static analysis framework for Web Components.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 855 | 🐛 93 | 🌐 Julia | 📅 2026-03-30 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-04-05 — Static Code Analysis for Julia
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,780 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,487 | 🐛 86 | 🌐 PHP | 📅 2026-04-03.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,354 | 🐛 119 | 🌐 PHP | 📅 2026-04-03 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,610 | 🐛 794 | 🌐 PHP | 📅 2026-04-03 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,590 | 🐛 69 | 🌐 PHP | 📅 2026-02-23 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,278 | 🐛 8 | 🌐 PHP | 📅 2026-03-30 — Checks code on every commit.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,303 | 🐛 3 | 🌐 Dockerfile | 📅 2026-03-30 — Many tools for PHP static analysis in one container.

* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,248 | 🐛 10 | 🌐 PHP | 📅 2026-03-17 — Easy to use architecture testing tool for PHP.

* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 886 | 🐛 35 | 🌐 PHP | 📅 2026-04-04 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [Progpilot](https://github.com/designsecurity/progpilot) ⭐ 362 | 🐛 4 | 🌐 PHP | 📅 2025-08-17 — A static analysis tool for security purposes.
...
* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 125 | 🐛 11 | 🌐 PHP | 📅 2026-04-04 — Reflection library to do Static Analysis for PHP Projects
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,353 | 🐛 246 | 🌐 Python | 📅 2026-03-29 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,420 | 🐛 56 | 🌐 Python | 📅 2026-03-26 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,769 | 🐛 24 | 🌐 Python | 📅 2025-12-22 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,529 | 🐛 30 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,076 | 🐛 33 | 🌐 Python | 📅 2026-03-30 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,957 | 🐛 50 | 🌐 Python | 📅 2024-10-20.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 371 | 🐛 134 | 🌐 Go | 📅 2026-04-01 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,889 | 🐛 41 | 🌐 Ruby | 📅 2026-03-27 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,743 | 🐛 58 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,057 | 🐛 25 | 🌐 Ruby | 📅 2026-03-30.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,912 | 🐛 29 | 🌐 Ruby | 📅 2026-01-12 — Identify database issues before they hit production.

* [Fasterer](https://github.com/DamirSvrtan/fasterer) ⭐ 1,822 | 🐛 12 | 🌐 Ruby | 📅 2024-06-14 — Common Ruby idioms checker.

* [Steep](https://github.com/soutaro/steep) ⭐ 1,480 | 🐛 220 | 🌐 Ruby | 📅 2026-04-03 — Gradual Typing for Ruby.
...
* [ERB Lint](https://github.com/Shopify/erb-lint) ⭐ 742 | 🐛 92 | 🌐 Ruby | 📅 2026-03-30 — Lint your ERB or HTML files
...
* [Skunk](https://github.com/fastruby/skunk) ⭐ 545 | 🐛 9 | 🌐 Ruby | 📅 2026-02-06 — A SkunkScore Calculator for Ruby Code -- Find the most complicated code without test coverage!
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,058 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,011 | 🐛 471 | 🌐 Rust | 📅 2026-04-01 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,096 | 🐛 101 | 📅 2026-04-05.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 932 | 🐛 25 | 🌐 Rust | 📅 2026-03-30 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code

* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 652 | 🐛 39 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,784 | 🐛 916 | 🌐 Rust | 📅 2026-04-01 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 816 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 132 | 🐛 6 | 🌐 Python | 📅 2026-04-03 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 554 | 🐛 49 | 🌐 Scala | 📅 2026-04-01 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,772 | 🐛 8 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,766 | 🐛 312 | 🌐 Swift | 📅 2026-03-30 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,184 | 🐛 308 | 🌐 TypeScript | 📅 2026-04-03 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,780 | 🐛 40 | 🌐 TypeScript | 📅 2026-04-03 — Linter for Angular projects
...
* [svls](https://github.com/dalance/svls) ⭐ 569 | 🐛 26 | 🌐 Rust | 📅 2026-04-02 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 364 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-03 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 72 | 🐛 2 | 🌐 Rust | 📅 2026-04-02 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,354 | 🐛 247 | 🌐 Go | 📅 2026-04-03 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,146 | 🐛 104 | 🌐 JavaScript | 📅 2026-04-04 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,535 | 🐛 647 | 🌐 Rust | 📅 2026-04-04 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,980 | 🐛 596 | 🌐 Vim Script | 📅 2026-04-01 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,426 | 🐛 1,375 | 🌐 CodeQL | 📅 2026-04-03 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,389 | 🐛 25 | 🌐 C# | 📅 2026-02-17 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 2,976 | 🐛 44 | 🌐 Java | 📅 2025-10-10 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,610 | 🐛 24 | 🌐 Go | 📅 2026-03-30 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.

* [weggli](https://github.com/googleprojectzero/weggli) ⭐ 2,486 | 🐛 47 | 🌐 Rust | 📅 2024-07-12 — A fast and robust semantic search tool for C and C++ codebases. It is designed to help security researchers identify interesting functionality in large codebases.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,319 | 🐛 52 | 🌐 Python | 📅 2026-03-30 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,670 | 🐛 1,054 | 📅 2026-04-01 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 979 | 🐛 72 | 🌐 C# | 📅 2026-03-30 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 839 | 🐛 149 | 🌐 Java | 📅 2026-04-01 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 784 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-03 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [todocheck](https://github.com/preslavmihaylov/todocheck) ⭐ 434 | 🐛 13 | 🌐 Go | 📅 2025-08-02 — Linter for integrating annotated TODOs with your issue trackers

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 362 | 🐛 3 | 🌐 Python | 📅 2026-04-04 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.

* [callGraph](https://github.com/koknat/callGraph) ⭐ 329 | 🐛 6 | 🌐 Perl | 📅 2024-11-20 — Statically generates a call graph image and displays it on screen.
...
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 107 | 🐛 9 | 🌐 Rust | 📅 2026-04-05 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.

* [relint](https://github.com/codingjoe/relint) ⭐ 65 | 🐛 0 | 🌐 Python | 📅 2026-03-30 — A static file linter that allows you to write custom rules using regular expressions (RegEx).
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 24 | 🐛 0 | 🌐 Rust | 📅 2026-04-02 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,584 | 🐛 604 | 🌐 Python | 📅 2026-04-05 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,408 | 🐛 63 | 🌐 C++ | 📅 2026-03-20 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,116 | 🐛 6 | 🌐 YARA | 📅 2026-03-11 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 846 | 🐛 152 | 🌐 C# | 📅 2026-04-01 — A binary static analysis tool that provides security and correctness results for Windows portable executables.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-04-05 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.

* [VMware chap](https://github.com/vmware/chap) ⭐ 393 | 🐛 8 | 🌐 C++ | 📅 2025-06-01 — chap analyzes un-instrumented ELF core files for leaks, memory growth, and corruption.  It is sufficiently reliable that it can be used in automation to catch leaks before  they are committed. As an interactive tool, it helps explain memory growth,  can identify some forms of corruption, and supplements a debugger  by giving the status of various memory locations.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,183 | 🐛 31 | 🌐 Go | 📅 2026-03-31 — Linter / Analyzer for Makefiles.
...
* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,974 | 🐛 14 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,609 | 🐛 67 | 🌐 Python | 📅 2026-04-01 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,373 | 🐛 43 | 🌐 Rust | 📅 2026-03-31 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.

* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,307 | 🐛 84 | 🌐 Ruby | 📅 2024-08-01 — A linter for AWS CloudFormation templates.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,040 | 🐛 258 | 🌐 Haskell | 📅 2026-03-09 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 11,945 | 🐛 394 | 🌐 Go | 📅 2026-04-03 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,962 | 🐛 49 | 🌐 Go | 📅 2026-04-03 — Vulnerability Static Analysis for Containers.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,582 | 🐛 182 | 🌐 Rust | 📅 2026-04-02 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 80 | 🐛 5 | 🌐 Python | 📅 2026-04-03 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,431 | 🐛 70 | 🌐 Go | 📅 2026-04-03 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,976 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,627 | 🐛 10 | 🌐 Go | 📅 2026-03-30 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.

* [krane](https://github.com/appvia/krane) ⭐ 738 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
  It identifies potential security risks in K8s RBAC design and makes suggestions on how to mitigate them. Krane dashboard presents current RBAC security posture and lets you navigate through its definition.

* [clusterlint](https://github.com/digitalocean/clusterlint) ⭐ 585 | 🐛 11 | 🌐 Go | 📅 2026-02-04 — Clusterlint queries live Kubernetes clusters for resources, executes common and  platform specific checks against these resources and provides actionable feedback to cluster operators.  It is a non invasive tool that is run externally. Clusterlint does not alter the resource configurations.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,431 | 🐛 70 | 🌐 Go | 📅 2026-04-03 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,971 | 🐛 81 | 🌐 JavaScript | 📅 2026-04-02 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,025 | 🐛 114 | 🌐 Ruby | 📅 2026-04-02 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 102 | 🐛 21 | 🌐 Rust | 📅 2026-04-02 — Format markdown code blocks using your favorite code formatters.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,238 | 🐛 242 | 🌐 Java | 📅 2026-03-17 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 863 | 🐛 46 | 🌐 Rust | 📅 2026-04-03 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 739 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)

<a name="nodejs" />
<h2>Node.js</h2>

* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 848 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-25 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 88 | 🌐 Python | 📅 2026-04-02 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 682 | 🐛 54 | 🌐 Go | 📅 2026-04-02 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,784 | 🐛 350 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,945 | 🐛 394 | 🌐 Go | 📅 2026-04-03 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,469 | 🐛 143 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,560 | 🐛 9 | 🌐 Java | 📅 2026-03-26 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,974 | 🐛 14 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,352 | 🐛 399 | 🌐 Go | 📅 2026-04-03 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,197 | 🐛 449 | 🌐 Python | 📅 2026-04-05 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,223 | 🐛 126 | 🌐 Python | 📅 2026-03-30 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [haml-lint](https://github.com/sds/haml-lint) ⭐ 335 | 🐛 12 | 🌐 Ruby | 📅 2026-03-23 — Tool for writing clean and consistent HAML.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 50 | 🐛 24 | 🌐 Python | 📅 2026-04-01 — A set of utilities for working with PO files to ease development and improve quality.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,517 | 🐛 248 | 🌐 JavaScript | 📅 2026-03-26 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,344 | 🐛 256 | 🌐 Python | 📅 2026-04-04 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,746 | 🐛 573 | 🌐 Go | 📅 2026-03-26 — A collection of tools and libraries for working with Go code, including linters and static analysis
