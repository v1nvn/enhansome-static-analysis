...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,509 | 🐛 39 | 🌐 Rust | 📅 2026-04-23
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,081 | 🐛 3 | 🌐 Markdown | 📅 2026-02-24.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,412 | 🐛 224 | 🌐 C# | 📅 2026-03-25 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,269 | 🐛 36 | 🌐 C# | 📅 2026-04-23 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,117 | 🐛 2 | 🌐 C# | 📅 2026-04-22 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 901 | 🐛 239 | 🌐 C# | 📅 2026-04-24 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,169 | 🐛 28 | 🌐 Elixir | 📅 2026-04-18 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,237 | 🐛 144 | 🌐 Go | 📅 2026-04-21 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,917 | 🐛 29 | 🌐 Go | 📅 2026-02-18 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,041 | 🐛 149 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.
...
* [wsl](https://github.com/bombsimon/wsl) ⭐ 348 | 🐛 4 | 🌐 Go | 📅 2026-04-23 — Enforces empty lines at the right places.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,592 | 🐛 306 | 🌐 Haskell | 📅 2026-03-22 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,117 | 🐛 166 | 🌐 Java | 📅 2026-04-23 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,039 | 🐛 149 | 🌐 Java | 📅 2026-04-23 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 420 | 🌐 Java | 📅 2026-04-23 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 28 | 🐛 18 | 🌐 Java | 📅 2026-04-23 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 80 | 🐛 31 | 🌐 Java | 📅 2026-04-17 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,509 | 🐛 39 | 🌐 Rust | 📅 2026-04-23 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,969 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-02 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,664 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,509 | 🐛 39 | 🌐 Rust | 📅 2026-04-23 — The JavaScript Code Quality Tool.
...
* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 70 | 🌐 Julia | 📅 2026-04-24 — Static Code Analysis for Julia
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 612 | 🐛 19 | 🌐 PHP | 📅 2026-04-20 — Fast detection of composer dependency issues.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,774 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,497 | 🐛 82 | 🌐 PHP | 📅 2026-04-22.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,371 | 🐛 124 | 🌐 PHP | 📅 2026-04-22 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,615 | 🐛 792 | 🌐 PHP | 📅 2026-04-19 — A modern static analyzer from etsy.
...
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,287 | 🐛 9 | 🌐 PHP | 📅 2026-04-16 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,925 | 🐛 30 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.
...
* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,252 | 🐛 11 | 🌐 PHP | 📅 2026-03-17 — Easy to use architecture testing tool for PHP.
...
* [parallel-lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) ⭐ 352 | 🐛 29 | 🌐 PHP | 📅 2026-04-20 — This tool checks syntax of PHP files faster than serial check with a fancier output.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,392 | 🐛 264 | 🌐 Python | 📅 2026-04-22 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,545 | 🐛 55 | 🌐 Python | 📅 2026-04-23 — Find unused classes, functions and variables in Python code.
...
* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,973 | 🐛 50 | 🌐 Python | 📅 2024-10-20.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 377 | 🐛 129 | 🌐 Go | 📅 2026-04-23 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,748 | 🐛 60 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,059 | 🐛 33 | 🌐 Ruby | 📅 2026-03-30.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,912 | 🐛 30 | 🌐 Ruby | 📅 2026-01-12 — Identify database issues before they hit production.
...
* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,176 | 🐛 5 | 🌐 Ruby | 📅 2026-04-24 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,071 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,050 | 🐛 474 | 🌐 Rust | 📅 2026-04-22 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,103 | 🐛 108 | 📅 2026-04-24.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,804 | 🐛 922 | 🌐 Rust | 📅 2026-04-21 — A tool for formatting Rust code according to style guidelines.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 133 | 🐛 6 | 🌐 Python | 📅 2026-04-23 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 555 | 🐛 49 | 🌐 Scala | 📅 2026-04-23 — Scala compiler plugin for static code analysis.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,782 | 🐛 285 | 🌐 Swift | 📅 2026-04-20 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,217 | 🐛 323 | 🌐 TypeScript | 📅 2026-04-23 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,782 | 🐛 39 | 🌐 TypeScript | 📅 2026-04-22 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 366 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-23 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,674 | 🐛 249 | 🌐 Go | 📅 2026-04-23 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,215 | 🐛 107 | 🌐 JavaScript | 📅 2026-04-23 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,841 | 🐛 623 | 🌐 Rust | 📅 2026-04-24 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,992 | 🐛 594 | 🌐 Vim Script | 📅 2026-04-15 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,515 | 🐛 1,373 | 🌐 CodeQL | 📅 2026-04-23 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,255 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,664 | 🐛 14 | 🌐 Ruby | 📅 2026-04-20 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,630 | 🐛 32 | 🌐 Go | 📅 2026-04-20 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,343 | 🐛 55 | 🌐 Python | 📅 2026-04-23 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,945 | 🐛 195 | 📅 2026-04-23 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,671 | 🐛 1,058 | 📅 2026-04-23 — Roslyn-based implementation of FxCop analyzers.
...
* [WALA](https://github.com/wala/WALA) ⭐ 843 | 🐛 150 | 🌐 Java | 📅 2026-04-23 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.
...
* [Depends](https://github.com/multilang-depends/depends) ⭐ 249 | 🐛 12 | 🌐 Java | 📅 2026-04-20 — Analyses the comprehensive dependencies of code elements for Java, C/C++, Ruby.
...
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 111 | 🐛 8 | 🌐 Rust | 📅 2026-04-20 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 24 | 🐛 0 | 🌐 Rust | 📅 2026-04-22 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 8,619 | 🐛 611 | 🌐 Python | 📅 2026-04-24 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,429 | 🐛 64 | 🌐 C++ | 📅 2026-03-20 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 849 | 🐛 160 | 🌐 C# | 📅 2026-04-22 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 819 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 575 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 571 | 🐛 2 | 🌐 C++ | 📅 2026-04-23 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,188 | 🐛 31 | 🌐 Go | 📅 2026-04-23 — Linter / Analyzer for Makefiles.
...
* [gixy](https://github.com/yandex/gixy) ⭐ 8,554 | 🐛 56 | 🌐 Python | 📅 2024-07-28 — A tool to analyze Nginx configuration. The main goal is to prevent misconfiguration and automate flaw detection.

<a name="configmanagement" />
<h2>Configuration Management</h2>

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,988 | 🐛 15 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,610 | 🐛 68 | 🌐 Python | 📅 2026-04-23 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,379 | 🐛 50 | 🌐 Rust | 📅 2026-04-22 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,078 | 🐛 256 | 🌐 Haskell | 📅 2026-04-23 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 12,074 | 🐛 396 | 🌐 Go | 📅 2026-04-22 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,970 | 🐛 47 | 🌐 Go | 📅 2026-04-23 — Vulnerability Static Analysis for Containers.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,582 | 🐛 183 | 🌐 Rust | 📅 2026-04-02 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 80 | 🐛 5 | 🌐 Python | 📅 2026-04-23 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,441 | 🐛 72 | 🌐 Go | 📅 2026-04-22 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,002 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,441 | 🐛 72 | 🌐 Go | 📅 2026-04-22 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,023 | 🐛 81 | 🌐 JavaScript | 📅 2026-04-24 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,034 | 🐛 120 | 🌐 Ruby | 📅 2026-04-19 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 103 | 🐛 23 | 🌐 Rust | 📅 2026-04-22 — Format markdown code blocks using your favorite code formatters.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 882 | 🐛 47 | 🌐 Rust | 📅 2026-04-24 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 745 | 🐛 8 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 163 | 🐛 92 | 🌐 Python | 📅 2026-04-23 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 688 | 🐛 56 | 🌐 Go | 📅 2026-04-22 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 26,254 | 🐛 360 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,074 | 🐛 396 | 🌐 Go | 📅 2026-04-22 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,487 | 🐛 144 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,568 | 🐛 8 | 🌐 Java | 📅 2026-04-16 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,988 | 🐛 15 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,400 | 🐛 392 | 🌐 Go | 📅 2026-04-23 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,217 | 🐛 454 | 🌐 Python | 📅 2026-04-22 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,525 | 🐛 252 | 🌐 JavaScript | 📅 2026-04-21 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,363 | 🐛 254 | 🌐 Python | 📅 2026-04-23 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,762 | 🐛 571 | 🌐 Go | 📅 2026-04-23 — A collection of tools and libraries for working with Go code, including linters and static analysis
