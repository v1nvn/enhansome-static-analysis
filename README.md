...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,497 | 🐛 35 | 🌐 Rust | 📅 2026-04-13
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,138 | 🐛 45 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,812 | 🐛 74 | 🌐 Python | 📅 2026-04-17 — Automated C++ checker that follows Google's style guide.

* [clazy](https://github.com/KDE/clazy) ⭐ 733 | 🐛 0 | 🌐 C++ | 📅 2026-04-10 — Qt-oriented static code analyzer based on the Clang framework. clazy is a compiler plugin which allows clang to understand Qt semantics. You get more than 50 Qt related compiler warnings, ranging from unneeded memory allocations to misusage of API, including fix-its for automatic refactoring.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,409 | 🐛 224 | 🌐 C# | 📅 2026-03-25 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,256 | 🐛 37 | 🌐 C# | 📅 2026-04-17 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,113 | 🐛 2 | 🌐 C# | 📅 2026-04-17 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 901 | 🐛 239 | 🌐 C# | 📅 2026-04-18 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,829 | 🐛 106 | 🌐 Clojure | 📅 2026-04-17 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,162 | 🐛 26 | 🌐 Elixir | 📅 2026-04-10 — A static code analysis tool with a focus on code consistency and teaching.
...
* [sobelow](https://github.com/nccgroup/sobelow) ⭐ 1,779 | 🐛 37 | 🌐 Elixir | 📅 2024-08-20 — Security-focused static analysis for the Phoenix Framework.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,229 | 🐛 143 | 🌐 Go | 📅 2026-04-18 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,915 | 🐛 29 | 🌐 Go | 📅 2026-02-18 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) ⭐ 3,127 | 🐛 30 | 🌐 Go | 📅 2018-10-27 — Concurrently runs many linters and normalises their output to a report.

* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,480 | 🐛 14 | 🌐 Go | 📅 2026-02-26 — Check that error return values are used.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,042 | 🐛 149 | 🌐 Go | 📅 2026-01-18 — Go source code linter that maintains checks which are currently not implemented in other linters.

* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,559 | 🐛 11 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.
...
* [unparam](https://github.com/mvdan/unparam) ⭐ 572 | 🐛 10 | 🌐 Go | 📅 2025-10-27 — Find unused function parameters.
...
* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 464 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.

* [dupl](https://github.com/mibk/dupl) ⭐ 366 | 🐛 4 | 🌐 Go | 📅 2026-03-05 — Reports potentially duplicated code.

* [wsl](https://github.com/bombsimon/wsl) ⭐ 349 | 🐛 6 | 🌐 Go | 📅 2026-04-14 — Enforces empty lines at the right places.
...
* [dogsled](https://github.com/alexkohler/dogsled) ⭐ 75 | 🐛 1 | 🌐 Go | 📅 2024-03-29 — Finds assignments/declarations with too many blank identifiers.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,589 | 🐛 293 | 🌐 Haskell | 📅 2026-03-22 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,111 | 🐛 166 | 🌐 Java | 📅 2026-04-14 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,036 | 🐛 148 | 🌐 Java | 📅 2026-04-15 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,136 | 🐛 431 | 🌐 Java | 📅 2026-04-14 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 28 | 🐛 18 | 🌐 Java | 📅 2026-04-09 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 80 | 🐛 31 | 🌐 Java | 📅 2026-04-17 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,497 | 🐛 35 | 🌐 Rust | 📅 2026-04-13 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,970 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-02 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,664 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,497 | 🐛 35 | 🌐 Rust | 📅 2026-04-13 — The JavaScript Code Quality Tool.

* [Polymer-analyzer](https://github.com/Polymer/tools/tree/master/packages/analyzer) ⭐ 436 | 🐛 865 | 🌐 TypeScript | 📅 2026-04-15 — A static analysis framework for Web Components.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 858 | 🐛 93 | 🌐 Julia | 📅 2026-04-14 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 70 | 🌐 Julia | 📅 2026-04-18 — Static Code Analysis for Julia
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 442 | 🐛 45 | 🌐 Lua | 📅 2026-04-14 — A tool for linting and static analysis of Lua code.
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 609 | 🐛 20 | 🌐 PHP | 📅 2026-04-10 — Fast detection of composer dependency issues.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,772 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,488 | 🐛 81 | 🌐 PHP | 📅 2026-04-17.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,367 | 🐛 124 | 🌐 PHP | 📅 2026-04-16 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,611 | 🐛 795 | 🌐 PHP | 📅 2026-04-06 — A modern static analyzer from etsy.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,591 | 🐛 71 | 🌐 PHP | 📅 2026-04-18 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,285 | 🐛 9 | 🌐 PHP | 📅 2026-04-16 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,919 | 🐛 29 | 🌐 PHP | 📅 2026-02-02 — Enforce rules for dependencies between software layers.

* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,312 | 🐛 3 | 🌐 Dockerfile | 📅 2026-04-13 — Many tools for PHP static analysis in one container.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 890 | 🐛 33 | 🌐 PHP | 📅 2026-04-14 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [parallel-lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) ⭐ 352 | 🐛 29 | 🌐 PHP | 📅 2026-04-13 — This tool checks syntax of PHP files faster than serial check with a fancier output.
...
* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 125 | 🐛 12 | 🌐 PHP | 📅 2026-04-13 — Reflection library to do Static Analysis for PHP Projects
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,382 | 🐛 257 | 🌐 Python | 📅 2026-04-15 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,532 | 🐛 56 | 🌐 Python | 📅 2026-03-26 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,776 | 🐛 23 | 🌐 Python | 📅 2026-04-14 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,526 | 🐛 30 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,074 | 🐛 33 | 🌐 Python | 📅 2026-04-13 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,968 | 🐛 50 | 🌐 Python | 📅 2024-10-20.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,279 | 🐛 47 | 🌐 Python | 📅 2026-03-25 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,265 | 🐛 63 | 🌐 Python | 📅 2026-04-17 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.

* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 953 | 🐛 43 | 🌐 Python | 📅 2026-04-13 — Autoflake removes unused imports and unused variables from Python code.
...
* [Dlint](https://github.com/dlint-py/dlint) ⭐ 176 | 🐛 23 | 🌐 Python | 📅 2026-01-07 — A tool for ensuring Python code is secure.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 373 | 🐛 132 | 🌐 Go | 📅 2026-04-17 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,891 | 🐛 43 | 🌐 Ruby | 📅 2026-04-13 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,747 | 🐛 59 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,058 | 🐛 31 | 🌐 Ruby | 📅 2026-03-30.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,482 | 🐛 206 | 🌐 Ruby | 📅 2026-04-14 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,176 | 🐛 5 | 🌐 Ruby | 📅 2026-03-24 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [ERB Lint](https://github.com/Shopify/erb-lint) ⭐ 742 | 🐛 92 | 🌐 Ruby | 📅 2026-04-13 — Lint your ERB or HTML files
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,066 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 3,038 | 🐛 477 | 🌐 Rust | 📅 2026-04-15 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,091 | 🐛 41 | 🌐 Rust | 📅 2025-12-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.

* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,571 | 🐛 52 | 🌐 Rust | 📅 2026-01-11 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,102 | 🐛 104 | 📅 2026-04-18.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 935 | 🐛 26 | 🌐 Rust | 📅 2026-03-30 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code

* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 655 | 🐛 40 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.

* [cargo-spellcheck](https://github.com/drahnr/cargo-spellcheck) ⭐ 359 | 🐛 57 | 🌐 Rust | 📅 2026-04-07 — Checks all your documentation for spelling and grammar mistakes  with hunspell (ready) and languagetool (preview)
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,795 | 🐛 922 | 🌐 Rust | 📅 2026-04-17 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 818 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [lockbud](https://github.com/BurtonQin/lockbud) ⭐ 589 | 🐛 27 | 🌐 Rust | 📅 2026-04-16 — Statically detects Rust deadlocks bugs. It currently detects two common kinds of deadlock bugs: doublelock and locks in conflicting order. It will print bugs in JSON format together with the source code location and an explanation of each bug.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 133 | 🐛 6 | 🌐 Python | 📅 2026-04-15 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 555 | 🐛 49 | 🌐 Scala | 📅 2026-04-14 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,776 | 🐛 8 | 🌐 Rust | 📅 2026-01-05 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,778 | 🐛 282 | 🌐 Swift | 📅 2026-04-14 — A library and command-line formatting tool for reformatting Swift code.
...
* [tclchecker](https://github.com/ActiveState/tdk/blob/master/docs/3.0/TDK_3.0_Checker.txt) ⭐ 82 | 🐛 5 | 🌐 Tcl | 📅 2024-05-17 — A static syntax analysis module (as part of [TDK](https://github.com/ActiveState/tdk) ⭐ 82 | 🐛 5 | 🌐 Tcl | 📅 2024-05-17).

<a name="typescript" />
<h2>TypeScript</h2>

* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,205 | 🐛 307 | 🌐 TypeScript | 📅 2026-04-17 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,781 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-18 — Linter for Angular projects
...
* [svls](https://github.com/dalance/svls) ⭐ 573 | 🐛 26 | 🌐 Rust | 📅 2026-04-02 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 365 | 🐛 78 | 🌐 TypeScript | 📅 2026-04-17 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 74 | 🐛 1 | 🌐 Rust | 📅 2026-04-16 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 34,572 | 🐛 247 | 🌐 Go | 📅 2026-04-17 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,193 | 🐛 104 | 🌐 JavaScript | 📅 2026-04-17 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,752 | 🐛 645 | 🌐 Rust | 📅 2026-04-17 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 13,989 | 🐛 594 | 🌐 Vim Script | 📅 2026-04-15 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,485 | 🐛 1,380 | 🌐 CodeQL | 📅 2026-04-17 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,252 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,665 | 🐛 14 | 🌐 Ruby | 📅 2026-04-13 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,622 | 🐛 31 | 🌐 Go | 📅 2026-04-14 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,339 | 🐛 55 | 🌐 Python | 📅 2026-04-17 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,944 | 🐛 196 | 📅 2026-03-24 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,671 | 🐛 1,058 | 📅 2026-04-06 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 984 | 🐛 63 | 🌐 C# | 📅 2026-04-16 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 840 | 🐛 150 | 🌐 Java | 📅 2026-04-17 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 784 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-17 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 223 | 🐛 3 | 🌐 Go | 📅 2026-04-16 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 106 | 🐛 7 | 🌐 Rust | 📅 2026-04-15 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.

* [relint](https://github.com/codingjoe/relint) ⭐ 65 | 🐛 0 | 🌐 Python | 📅 2026-04-13 — A static file linter that allows you to write custom rules using regular expressions (RegEx).
...
* [angr](https://github.com/angr/angr) ⭐ 8,609 | 🐛 605 | 🌐 Python | 📅 2026-04-18 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,424 | 🐛 64 | 🌐 C++ | 📅 2026-03-20 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,120 | 🐛 6 | 🌐 YARA | 📅 2026-03-11 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 847 | 🐛 158 | 🌐 C# | 📅 2026-04-14 — A binary static analysis tool that provides security and correctness results for Windows portable executables.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 570 | 🐛 2 | 🌐 C++ | 📅 2026-04-18 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,188 | 🐛 32 | 🌐 Go | 📅 2026-04-13 — Linter / Analyzer for Makefiles.
...
* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,985 | 🐛 15 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,609 | 🐛 68 | 🌐 Python | 📅 2026-04-17 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,377 | 🐛 50 | 🌐 Rust | 📅 2026-04-14 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,067 | 🐛 256 | 🌐 Haskell | 📅 2026-04-17 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [Grype](https://github.com/anchore/grype) ⭐ 12,041 | 🐛 390 | 🌐 Go | 📅 2026-04-17 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,970 | 🐛 51 | 🌐 Go | 📅 2026-04-17 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,242 | 🐛 41 | 🌐 Go | 📅 2026-04-04 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,583 | 🐛 183 | 🌐 Rust | 📅 2026-04-02 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 81 | 🐛 5 | 🌐 Python | 📅 2026-04-13 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,438 | 🐛 73 | 🌐 Go | 📅 2026-04-17 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,996 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,627 | 🐛 10 | 🌐 Go | 📅 2026-04-13 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.

* [krane](https://github.com/appvia/krane) ⭐ 739 | 🐛 55 | 🌐 Ruby | 📅 2026-02-13 — Krane is a simple Kubernetes RBAC static analysis tool.
  It identifies potential security risks in K8s RBAC design and makes suggestions on how to mitigate them. Krane dashboard presents current RBAC security posture and lets you navigate through its definition.

* [clusterlint](https://github.com/digitalocean/clusterlint) ⭐ 587 | 🐛 11 | 🌐 Go | 📅 2026-02-04 — Clusterlint queries live Kubernetes clusters for resources, executes common and  platform specific checks against these resources and provides actionable feedback to cluster operators.  It is a non invasive tool that is run externally. Clusterlint does not alter the resource configurations.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,438 | 🐛 73 | 🌐 Go | 📅 2026-04-17 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,011 | 🐛 79 | 🌐 JavaScript | 📅 2026-04-17 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,032 | 🐛 115 | 🌐 Ruby | 📅 2026-04-02 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 103 | 🐛 20 | 🌐 Rust | 📅 2026-04-14 — Format markdown code blocks using your favorite code formatters.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 872 | 🐛 46 | 🌐 Rust | 📅 2026-04-17 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 741 | 🐛 8 | 🌐 Rust | 📅 2025-12-15 — Scan Nix files for dead code (unused variable bindings)

<a name="nodejs" />
<h2>Node.js</h2>

* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 850 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-25 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 163 | 🐛 91 | 🌐 Python | 📅 2026-04-17 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 685 | 🐛 55 | 🌐 Go | 📅 2026-04-08 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,996 | 🐛 358 | 🌐 Go | 📅 2026-03-25 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,041 | 🐛 390 | 🌐 Go | 📅 2026-04-17 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,482 | 🐛 143 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,565 | 🐛 6 | 🌐 Java | 📅 2026-04-16 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 6,985 | 🐛 15 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,377 | 🐛 400 | 🌐 Go | 📅 2026-04-17 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,202 | 🐛 451 | 🌐 Python | 📅 2026-04-15 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,234 | 🐛 126 | 🌐 Python | 📅 2026-03-30 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [haml-lint](https://github.com/sds/haml-lint) ⭐ 335 | 🐛 11 | 🌐 Ruby | 📅 2026-04-13 — Tool for writing clean and consistent HAML.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 50 | 🐛 26 | 🌐 Python | 📅 2026-04-14 — A set of utilities for working with PO files to ease development and improve quality.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,522 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-16 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,356 | 🐛 253 | 🌐 Python | 📅 2026-04-16 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,757 | 🐛 572 | 🌐 Go | 📅 2026-04-09 — A collection of tools and libraries for working with Go code, including linters and static analysis
