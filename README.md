...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,420 | 🐛 16 | 🌐 Rust | 📅 2026-03-01
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,117 | 🐛 44 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,389 | 🐛 216 | 🌐 C# | 📅 2026-02-28 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,216 | 🐛 34 | 🌐 C# | 📅 2026-03-08 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,096 | 🐛 4 | 🌐 C# | 📅 2026-03-08 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,142 | 🐛 31 | 🌐 Elixir | 📅 2026-03-08 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,785 | 🐛 78 | 🌐 Elixir | 📅 2025-11-06 — Mix tasks to simplify use of Dialyzer in Elixir projects.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,127 | 🐛 143 | 🌐 Go | 📅 2026-03-08 — A tool for posting review comments from any linter in any code hosting service.
...
* [wsl](https://github.com/bombsimon/wsl) ⭐ 345 | 🐛 2 | 🌐 Go | 📅 2026-03-08 — Enforces empty lines at the right places.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,087 | 🐛 164 | 🌐 Java | 📅 2026-03-03 — Reformats Java source code to comply with Google Java Style
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,420 | 🐛 16 | 🌐 Rust | 📅 2026-03-01 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,664 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,420 | 🐛 16 | 🌐 Rust | 📅 2026-03-01 — The JavaScript Code Quality Tool.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,788 | 🐛 252 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,471 | 🐛 86 | 🌐 PHP | 📅 2026-03-08.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,321 | 🐛 111 | 🌐 PHP | 📅 2026-03-06 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,603 | 🐛 799 | 🌐 PHP | 📅 2026-03-09 — A modern static analyzer from etsy.
...
* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,273 | 🐛 5 | 🌐 PHP | 📅 2026-02-03 — Checks code on every commit.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,302 | 🐛 4 | 🌐 Dockerfile | 📅 2026-03-02 — Many tools for PHP static analysis in one container.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 870 | 🐛 31 | 🌐 PHP | 📅 2026-03-08 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,284 | 🐛 224 | 🌐 Python | 📅 2026-03-06 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,740 | 🐛 51 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,054 | 🐛 19 | 🌐 Ruby | 📅 2026-03-07.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,476 | 🐛 190 | 🌐 Ruby | 📅 2026-03-06 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,167 | 🐛 3 | 🌐 Ruby | 📅 2026-03-08 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [kani](https://github.com/model-checking/kani) ⭐ 2,976 | 🐛 479 | 🌐 Rust | 📅 2026-03-09 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,769 | 🐛 908 | 🌐 Rust | 📅 2026-03-06 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 805 | 🐛 15 | 🌐 Rust | 📅 2026-03-04 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 554 | 🐛 50 | 🌐 Scala | 📅 2026-03-08 — Scala compiler plugin for static code analysis.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,723 | 🐛 305 | 🌐 Swift | 📅 2026-03-07 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,138 | 🐛 306 | 🌐 TypeScript | 📅 2026-03-08 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,778 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-08 — Linter for Angular projects
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 70 | 🐛 3 | 🌐 Rust | 📅 2026-03-09 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 33,030 | 🐛 233 | 🌐 Go | 📅 2026-03-06 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,181 | 🐛 106 | 🌐 JavaScript | 📅 2026-03-08 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 19,758 | 🐛 513 | 🌐 Rust | 📅 2026-03-09 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 9,298 | 🐛 1,295 | 🌐 CodeQL | 📅 2026-03-06 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,590 | 🐛 25 | 🌐 Go | 📅 2026-03-09 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,285 | 🐛 50 | 🌐 Python | 📅 2026-03-02 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-08 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [angr](https://github.com/angr/angr) ⭐ 8,533 | 🐛 596 | 🌐 Python | 📅 2026-03-06 — Binary code analysis tool that also supports symbolic execution.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-03-08 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,608 | 🐛 98 | 🌐 Python | 📅 2026-03-08 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 11,682 | 🐛 376 | 🌐 Go | 📅 2026-03-08 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [clair](https://github.com/coreos/clair) ⭐ 10,939 | 🐛 47 | 🌐 Go | 📅 2026-03-06 — Vulnerability Static Analysis for Containers.
...
* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 2,958 | 🐛 85 | 🌐 Go | 📅 2025-10-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,617 | 🐛 8 | 🌐 Go | 📅 2026-03-03 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,911 | 🐛 82 | 🌐 JavaScript | 📅 2026-03-09 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,011 | 🐛 153 | 🌐 Ruby | 📅 2025-12-01 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 99 | 🐛 15 | 🌐 Rust | 📅 2026-03-08 — Format markdown code blocks using your favorite code formatters.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 678 | 🐛 49 | 🌐 Go | 📅 2026-03-09 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,280 | 🐛 346 | 🌐 Go | 📅 2026-02-21 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 11,682 | 🐛 376 | 🌐 Go | 📅 2026-03-08 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,436 | 🐛 140 | 🌐 Python | 📅 2025-03-13 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,294 | 🐛 385 | 🌐 Go | 📅 2026-03-05 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,160 | 🐛 438 | 🌐 Python | 📅 2026-03-04 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,731 | 🐛 569 | 🌐 Go | 📅 2026-02-25 — A collection of tools and libraries for working with Go code, including linters and static analysis
