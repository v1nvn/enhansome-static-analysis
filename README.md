...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,443 | 🐛 17 | 🌐 Rust | 📅 2026-03-17
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,078 | 🐛 1 | 🌐 Markdown | 📅 2026-02-24.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,124 | 🐛 44 | 🌐 C++ | 📅 2025-04-24 — A sound static analyzer for C/C++ code based on LLVM.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,391 | 🐛 220 | 🌐 C# | 📅 2026-02-28 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,228 | 🐛 34 | 🌐 C# | 📅 2026-03-17 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,100 | 🐛 4 | 🌐 C# | 📅 2026-03-17 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 897 | 🐛 241 | 🌐 C# | 📅 2026-03-19 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,826 | 🐛 106 | 🌐 Clojure | 📅 2026-03-17 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,151 | 🐛 137 | 🌐 Go | 📅 2026-03-18 — A tool for posting review comments from any linter in any code hosting service.

* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 3,890 | 🐛 28 | 🌐 Go | 📅 2026-02-18 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,581 | 🐛 293 | 🌐 Haskell | 📅 2025-12-27 — HLint is a tool for suggesting possible improvements to Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,092 | 🐛 164 | 🌐 Java | 📅 2026-03-17 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,022 | 🐛 144 | 🌐 Java | 📅 2026-03-10 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,133 | 🐛 431 | 🌐 Java | 📅 2026-03-19 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 521 | 🐛 59 | 🌐 Java | 📅 2026-03-19 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 27 | 🐛 18 | 🌐 Java | 📅 2026-03-17 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 75 | 🐛 29 | 🌐 Java | 📅 2026-02-28 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,443 | 🐛 17 | 🌐 Rust | 📅 2026-03-17 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,962 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-14 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,667 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,443 | 🐛 17 | 🌐 Rust | 📅 2026-03-17 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 854 | 🐛 90 | 🌐 Julia | 📅 2026-03-18 — Static type inference system to detect bugs and type instabilities.

* [StaticLint](https://github.com/julia-vscode/StaticLint.jl) ⭐ 159 | 🐛 69 | 🌐 Julia | 📅 2026-03-20 — Static Code Analysis for Julia
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,427 | 🐛 64 | 🌐 PHP | 📅 2026-02-26 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,790 | 🐛 249 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,478 | 🐛 83 | 🌐 PHP | 📅 2026-03-13.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,337 | 🐛 114 | 🌐 PHP | 📅 2026-03-19 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,608 | 🐛 798 | 🌐 PHP | 📅 2026-03-20 — A modern static analyzer from etsy.
...
* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,244 | 🐛 10 | 🌐 PHP | 📅 2026-03-17 — Easy to use architecture testing tool for PHP.

* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 880 | 🐛 36 | 🌐 PHP | 📅 2026-03-15 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 126 | 🐛 11 | 🌐 PHP | 📅 2026-03-19 — Reflection library to do Static Analysis for PHP Projects
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,322 | 🐛 231 | 🌐 Python | 📅 2026-03-18 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,995 | 🐛 73 | 🌐 Python | 📅 2026-02-11.

* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,385 | 🐛 57 | 🌐 Python | 📅 2026-03-04 — Find unused classes, functions and variables in Python code.
...
* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 1,949 | 🐛 50 | 🌐 Python | 📅 2024-10-20.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,270 | 🐛 306 | 🌐 R | 📅 2026-03-13 — Static Code Analysis for R.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,889 | 🐛 40 | 🌐 Ruby | 📅 2026-03-19 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,741 | 🐛 55 | 🌐 Ruby | 📅 2025-12-03 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,054 | 🐛 20 | 🌐 Ruby | 📅 2026-03-18.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,909 | 🐛 27 | 🌐 Ruby | 📅 2026-01-12 — Identify database issues before they hit production.

* [Fasterer](https://github.com/DamirSvrtan/fasterer) ⭐ 1,822 | 🐛 12 | 🌐 Ruby | 📅 2024-06-14 — Common Ruby idioms checker.

* [Steep](https://github.com/soutaro/steep) ⭐ 1,480 | 🐛 189 | 🌐 Ruby | 📅 2026-03-19 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,169 | 🐛 2 | 🌐 Ruby | 📅 2026-03-15 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,049 | 🐛 9 | 🌐 Rust | 📅 2026-02-12 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [kani](https://github.com/model-checking/kani) ⭐ 2,985 | 🐛 478 | 🌐 Rust | 📅 2026-03-16 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,084 | 🐛 40 | 🌐 Rust | 📅 2025-12-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,093 | 🐛 100 | 📅 2026-03-20.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,776 | 🐛 912 | 🌐 Rust | 📅 2026-03-15 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 813 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,159 | 🐛 315 | 🌐 TypeScript | 📅 2026-03-18 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,779 | 🐛 32 | 🌐 TypeScript | 📅 2026-03-19 — Linter for Angular projects
...
* [svls](https://github.com/dalance/svls) ⭐ 564 | 🐛 26 | 🌐 Rust | 📅 2026-03-18 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 357 | 🐛 77 | 🌐 TypeScript | 📅 2026-03-19 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 71 | 🐛 1 | 🌐 Rust | 📅 2026-03-17 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 33,212 | 🐛 230 | 🌐 Go | 📅 2026-03-19 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,203 | 🐛 100 | 🌐 JavaScript | 📅 2026-03-19 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 20,169 | 🐛 588 | 🌐 Rust | 📅 2026-03-20 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 9,363 | 🐛 1,312 | 🌐 CodeQL | 📅 2026-03-19 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,239 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,670 | 🐛 1,054 | 📅 2026-03-18 — Roslyn-based implementation of FxCop analyzers.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 217 | 🐛 7 | 🌐 Go | 📅 2026-03-12 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 106 | 🐛 14 | 🌐 Rust | 📅 2026-03-20 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.
...
* [angr](https://github.com/angr/angr) ⭐ 8,555 | 🐛 595 | 🌐 Python | 📅 2026-03-20 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,398 | 🐛 62 | 🌐 C++ | 📅 2026-02-14 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 840 | 🐛 156 | 🌐 C# | 📅 2026-03-19 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 813 | 🐛 15 | 🌐 Rust | 📅 2026-03-18 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 569 | 🐛 2 | 🌐 C++ | 📅 2026-03-19 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,581 | 🐛 178 | 🌐 Rust | 📅 2026-01-31 — Official linter for Deno.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,417 | 🐛 73 | 🌐 Go | 📅 2026-03-19 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,417 | 🐛 73 | 🌐 Go | 📅 2026-03-19 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 5,940 | 🐛 81 | 🌐 JavaScript | 📅 2026-03-18 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,236 | 🐛 241 | 🌐 Java | 📅 2026-03-17 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 850 | 🐛 47 | 🌐 Rust | 📅 2026-03-20 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 163 | 🐛 92 | 🌐 Python | 📅 2026-03-16 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,487 | 🐛 352 | 🌐 Go | 📅 2026-03-12 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,167 | 🐛 439 | 🌐 Python | 📅 2026-03-18 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,214 | 🐛 125 | 🌐 Python | 📅 2026-03-17 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,519 | 🐛 247 | 🌐 JavaScript | 📅 2026-03-18 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,335 | 🐛 253 | 🌐 Python | 📅 2026-03-16 — Check code for common misspellings.
